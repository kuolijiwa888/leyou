				...
				<div class="page-container">
					...
					<form method="post" action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}">
						<table id="tbBasicTable" lay-filter="tbBasicTable">
							<thead>
								<tr>
									<th lay-data="{field:'groupid',sort:true,align: 'center',totalRowText: '页面小计',width:165}">单号</th>
									<th lay-data="{field:'username1',sort:true,align: 'center',width:165}">用户名</th>
									<th lay-data="{field:'username2',sort:true,align: 'center',width:165}">类型</th>
									<th lay-data="{field:'username3',sort:true,align: 'center',width:165,totalRow: true}">账变前金额</th>
									<th lay-data="{field:'username4',sort:true,align: 'center',width:165,totalRow: true}">账变金额</th>
									<th lay-data="{field:'username5',sort:true,align: 'center',width:165,totalRow: true}">账变后金额</th>
									<th lay-data="{field:'username6',sort:true,align: 'center',minWidth:200}">备注</th>
									<th lay-data="{field:'username7',sort:true,align: 'center',width:165}">时间</th>
									<th lay-data="{field:'userbankname4',sort:true,align: 'center',width:100}">操作</th>
								</tr> 
							</thead>
							<tbody>
