      ...
      <div class="layui-card-body">
        ...
        <form action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}" method="post" class="layui-form" id="AjaxPostForm" lay-filter="AjaxPostForm">
          ...
          <div class="layui-form-item">
            <label class="layui-form-label">{$passtext}:</label>
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="" placeholder="{$passtext}" name="oldpassword">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="" placeholder="新密码" name="password">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="" placeholder="新安全密码" name="safecode">
            </div>
          </div>
          {/if}
