            ...
            <table id="tbBasicTable" lay-filter="tbBasicTable">
              <thead>
                <tr>
                  ...
                  <th lay-data="{field:'username',sort:true,align: 'center'}">轮播图地址</th>
                  <th lay-data="{field:'username1',sort:true,align: 'center'}">备注</th>
                  <th lay-data="{field:'userbankname',sort:true,align: 'center'}">类型</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{$vo.address}</td>
                  <td>{$vo.beizhu}</td>
                  <td>{if condition="$vo['is_mobile'] eq 1"}APP轮播图{else /}PC轮播图{/if}</td>
                  <td>
                    <u style="cursor:pointer" class="layui-btn layui-btn-primary layui-btn-xs" layer-url="{:U('modify',['id'=>$vo['id']])}" title="修改-{$vo.title}">修改</u>
                  </td>
                  {/volist}
                </tbody>
              </table>
