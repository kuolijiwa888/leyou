					...
					<form class="layui-form toolbar" method="get" action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}">
						<div class="layui-form-item">
							<div class="layui-inline">&emsp;
								<a class="layui-btn icon-btn" type="submit" layer-url="{:U('gonggaoadd')}" lay-filter="loginRecordTbSearch" lay-submit>
						...
						<table id="tbBasicTable" lay-filter="tbBasicTable">
							<thead>
								<tr>
									...
									<th lay-data="{field:'username',sort:true,align: 'center',width:300}">公告标题</th>
									<th lay-data="{field:'userbankname2',sort:true,align: 'center'}">公告内容</th>
									<th lay-data="{field:'userbankname1',sort:true,align: 'center',width:300}">发布时间</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="td-manage">
										<u style="cursor:pointer" class="layui-btn layui-btn-primary layui-btn-xs" layer-url="{:U('gonggaoedit',['id'=>$vo['id']])}" title="编辑">编辑</u> 
										<u style="cursor:pointer" class="layui-btn layui-btn-danger layui-btn-xs" layer-del-url="{:U('gonggaodelete',['id'=>$vo['id']])}" title="删除">删除</u>
									</td>
								</tr>
								{/volist}
							</tbody>
