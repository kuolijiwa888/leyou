        ...
        <div class="page-container">
          ...
          <form method="post" action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}">
            <table id="tbBasicTable" lay-filter="tbBasicTable">
              <thead>
                <tr>
                  <th lay-data="{field:'id',sort:true,align: 'center'}">真人帐号</th>
                  <th lay-data="{field:'username',sort:true,align: 'center'}">下注单数</th>
                  <th lay-data="{field:'userbankname',sort:true,align: 'center'}">投注额度</th>
                  <th lay-data="{field:'proxy',sort:true,align: 'center'}">有效投注额度</th>
                  <th lay-data="{field:'jinjijilu',sort:true,align: 'center'}">会员派彩</th>
                </tr> 
              </thead>
              <tbody>
