				...
				<form action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}" method="post" class="layui-form" id="AjaxPostForm" lay-filter="AjaxPostForm">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" class="layui-input" value="{$info.title}" placeholder="通知标题" name="title" lay-verType="tips" lay-verify="required" required>
							<input type="hidden" class="input-text" value="{$add_time}" name="add_time">
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						<label class="layui-form-label">通知会员id:</label>
						<div class="layui-input-block" id="IsPurchased">
							<textarea name="users" rows="20" cols="50" placeholder="1,2,3" class="layui-textarea">{$info.users}</textarea>
							<small>多人请用英文符号,号隔开。为空则全部发送</small>
						</div>
					</div>
