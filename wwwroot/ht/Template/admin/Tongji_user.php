            ...
            <table id="tbBasicTable" lay-filter="tbBasicTable">
              <thead>
                <tr>
                  ...
                  <th lay-data="{field:'groupid',sort:true,align: 'center',totalRow: true}">自动充值</th>
                  <th lay-data="{field:'username',sort:true,align: 'center',totalRow: true}">手动加款</th>
                  <th lay-data="{field:'userbankname',sort:true,align: 'center',totalRow: true}">手动减款</th>
                  <th lay-data="{field:'shangji',sort:true,align: 'center',totalRow: true}">提款</th>
                  <th lay-data="{field:'proxy',sort:true,align: 'center',totalRow: true}">充提盈亏</th>
                  <th lay-data="{field:'jinjijilu',sort:true,align: 'center',totalRow: true}">投注</th>
                  <th lay-data="{field:'balance',sort:true,align: 'center',totalRow: true}">返奖</th>
                  <th lay-data="{field:'point',sort:true,align: 'center',totalRow: true}">活动</th>
                  <th lay-data="{field:'fandian',sort:true,align: 'center',totalRow: true}">投注盈亏</th>
                  <th lay-data="{field:'yeb',sort:true,align: 'center'}">时间段</th>
                </tr> 
              </thead>
              <tbody>
