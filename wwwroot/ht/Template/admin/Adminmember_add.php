      ...
      <div class="layui-card-body">
        ...
        <form action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}" method="post" class="layui-form" id="AjaxPostForm" lay-filter="AjaxPostForm">
          ...
          <div class="layui-form-item">
            <label class="layui-form-label layui-form-required">管理组:</label>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="" placeholder="密码" name="password">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">安全码:</label>
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="{$info.safecode}" placeholder="安全码" name="safecode">
            </div>
          </div>
          {else /}
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="{$info.username}" placeholder="用户名" name="username">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">密码:</label>
          ...
          <div class="layui-form-item">
            <label class="layui-form-label">安全码:</label>
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="" placeholder="安全码" name="safecode">
            </div>
          </div>
          {/present}
