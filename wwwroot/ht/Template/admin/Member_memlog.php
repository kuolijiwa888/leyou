          ...
          <form class="layui-form toolbar" method="get" action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}">
            <div class="layui-form-item">
              <div class="layui-inline">
                <label class="layui-form-label"style="width:62px;">登陆时间:</label>
              ...
              <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="loginip" value="{$loginip}" class="layui-input" placeholder="输入登陆IP"/>
                </div>
              </div>
            ...
            <table id="tbBasicTable" lay-filter="tbBasicTable">
              <thead>
                <tr>
                  ...
                  <th lay-data="{field:'userbankname1',sort:true,align: 'center'}">类型</th>
                  <th lay-data="{field:'userbankname2',sort:true,align: 'center'}">备注</th>
                  <th lay-data="{field:'userbankname3',sort:true,align: 'center'}">IP</th>
                  <th lay-data="{field:'userbankname4',sort:true,align: 'center'}">IP所属地</th>
                  <th lay-data="{field:'useredit1',align: 'center'}">时间</th>
                </tr> 
              </thead>
              <tbody>
