      ...
      <div class="layui-card-body">
        ...
        <form action="{:U(CONTROLLER_NAME.'/'.ACTION_NAME)}" method="post" class="layui-form" id="AjaxPostForm" lay-filter="AjaxPostForm">
          ...
          <div class="layui-form-item">
            <label class="layui-form-label">利润名称:</label>
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="{$info.name}" placeholder="利润名称" name="name">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">天数:</label>
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="{$info.day}" placeholder="天数" name="day">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">利润:</label>
            <div class="layui-input-block">
              <input type="text" class="layui-input" value="{$info.liyun}" placeholder="利润" name="liyun">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">是否起用:</label>
            <div class="layui-input-block" id="IsPurchased">
              <input type="radio" id="istitle-1" name="state" value="1" {if condition="$info[state] eq 1"}checked{/if} title="是" lay-filter="ascn">
              <input type="radio" id="istitle-0" name="state" value="0" {if condition="$info[state] eq 0"}checked{/if} title="否" lay-filter="ascn">
            </div>
          </div>
