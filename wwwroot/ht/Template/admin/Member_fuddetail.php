            ...
            <table id="tbBasicTable" lay-filter="tbBasicTable">
              <thead>
                <tr>
                  ...
                  <th lay-data="{field:'paytype',sort:true,align: 'center'}">类型</th>
                  <th lay-data="{field:'paytypetitle',sort:true,align: 'center'}">账变前金额</th>
                  <th lay-data="{field:'oldaccountmoney',sort:true,align: 'center'}">账变金额</th>
                  <th lay-data="{field:'amount',sort:true,align: 'center'}">账变后金额</th>
                  <th lay-data="{field:'newaccountmoney',sort:true,align: 'center'}">备注</th>
                  <th lay-data="{field:'remark',sort:true,align: 'center'}">时间</th>
                </tr> 
              </thead>
              <tbody>
