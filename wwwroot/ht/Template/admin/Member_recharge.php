    ...
    <div class="layui-card">
      <div class="layui-card-body">
            ...
            <table id="tbBasicTable" lay-filter="tbBasicTable">
              <thead>
                <tr>
                  ...
                  <th lay-data="{field:'paytype',sort:true,align: 'center'}">支付账号</th>
                  <th lay-data="{field:'paytypetitle',sort:true,align: 'center'}">存款方式</th>
                  <th lay-data="{field:'oldaccountmoney',sort:true,align: 'center'}">充值前</th>
                  <th lay-data="{field:'amount',sort:true,align: 'center'}">金额</th>
                  <th lay-data="{field:'newaccountmoney',sort:true,align: 'center'}">充值后</th>
                  <th lay-data="{field:'remark',sort:true,align: 'center'}">备注</th>
                  <th lay-data="{field:'isauto',sort:true,align: 'center'}">类型</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  {/if}</td>
                  <td><a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" layer-del-url="{:U('rechargedelete',array('id'=>$vo['id']))}">删除</a></td>
                </tr>
                {/volist}
              </tbody>
            </table>
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <div class="l" style="padding:0">页面成功：<strong style="color:#f60">{$yemiantotal}</strong>元</div>总充值：<strong style="color:#f60">{$rechalltotal}</strong>({$rechalltotal_count}笔)&nbsp;&nbsp;&nbsp;&nbsp;自动充值：<strong style="color:#f60">{$rechtotal_aotu}</strong>({$rechtotal_aotu_count}笔)&nbsp;&nbsp;&nbsp;&nbsp;手动充值：<strong style="color:#f60">{$rechtotal_shou}</strong>({$rechtotal_shou_count}笔)
            </div>
        </div>
      </form>
    </div>
