<?php
$api = "http://api.b1api.com/api?p=xml&t=gsk3&limit=1&token=c8ac995dbb2ad9c1";
...
echo '{"sign":true,"message":"获取成功","data":[{"title":"甘肃快3","name":"shk3","expect":"'.$qh.'","opencode":"'.$hm.'","opentime":"'.$rq.'","source":"开彩采集","sourcecode":""}]}';
