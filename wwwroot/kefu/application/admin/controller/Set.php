        ...
        try {
            ...
            var cgwl ={
                 ...
                 blank:function(groupid){
                  ...
                  var web =encodeURI('{$url}{$this->base_root}/index/index/home?visiter_id='+ymwl.visiter_id+'&visiter_name='+ymwl.visiter_name+'&avatar='+ymwl.avatar+'&business_id={$business_id}&groupid='+groupid+'&product='+ymwl.product);
                      
                  var moblieweb = encodeURI('{$url}{$this->base_root}/mobile/index/home?visiter_id='+ymwl.visiter_id+'&visiter_name='+ymwl.visiter_name+'&avatar='+ymwl.avatar+'&business_id={$business_id}&groupid='+groupid+'&product='+ymwl.product);
             ...
             */
                ...
                var cgwl ={
                     ...
                     connenct:function(groupid){
                      var id =groupid;
                      var web =encodeURI('{$url}{$this->base_root}/layer?visiter_id='+ymwl.visiter_id+'&visiter_name='+ymwl.visiter_name+'&avatar='+ymwl.avatar+'&business_id={$business_id}&groupid='+groupid+'&product='+ymwl.product);
