	...
	function xy28(){
		...
		$xy28 = [
			...
			'tmbs'=>[
				'title'=>'特码包三',
				'list'=>[
					['playid'=>'xy28_tmbs','rate'=>1,'title'=>'特码包三'],
			...
			'hunhe'=>[
				...
				'list'=>[
					...
					['playid'=>'xy28_hunhe_baozi','rate'=>1,'title'=>'豹子'],
				],
			...
			'bs'=>[
				'title'=>'波色',
				'list'=>[
					['playid'=>'xy28_bs_hong','rate'=>1,'title'=>'红波'],
					['playid'=>'xy28_bs_lv','rate'=>1,'title'=>'绿波'],
					['playid'=>'xy28_bs_lan','rate'=>1,'title'=>'蓝波'],
	...
	function pk10(){
		$pk10 = [
			...
			'gyh'=>[
				'title'=>'冠、亚和',
				'list'=>[
					['playid'=>'pk10gyhz','title'=>'冠、亚和值'],
					['playid'=>'pk10gyhd','title'=>'和大'],
					['playid'=>'pk10gyhx','title'=>'和小'],
					['playid'=>'pk10gyhdd','title'=>'和单'],
					['playid'=>'pk10gyhss','title'=>'和双'],
				],
			],
			'gyhz'=>[
				'title'=>'冠、亚和值',
				'list'=>[
					['playid'=>'pk10gyhz3','title'=>'3'],
					['playid'=>'pk10gyhz4','title'=>'4'],
					['playid'=>'pk10gyhz5','title'=>'5'],
					['playid'=>'pk10gyhz6','title'=>'6'],
					['playid'=>'pk10gyhz7','title'=>'7'],
					['playid'=>'pk10gyhz8','title'=>'8'],
					['playid'=>'pk10gyhz9','title'=>'9'],
					['playid'=>'pk10gyhz10','title'=>'10'],
					['playid'=>'pk10gyhz11','title'=>'11'],
					['playid'=>'pk10gyhz12','title'=>'12'],
					['playid'=>'pk10gyhz13','title'=>'13'],
					['playid'=>'pk10gyhz14','title'=>'14'],
					['playid'=>'pk10gyhz15','title'=>'15'],
					['playid'=>'pk10gyhz16','title'=>'16'],
					['playid'=>'pk10gyhz17','title'=>'17'],
					['playid'=>'pk10gyhz18','title'=>'18'],
					['playid'=>'pk10gyhz19','title'=>'19'],
				],
			],
			'mc'=>[
				'title'=>'名次',
				'list'=>[
					['playid'=>'pk10mc1','title'=>'冠军'],
					['playid'=>'pk10mc2','title'=>'亚军'],
					['playid'=>'pk10mc3','title'=>'季军'],
					['playid'=>'pk10mc4','title'=>'第四名'],
					['playid'=>'pk10mc5','title'=>'第五名'],
					['playid'=>'pk10mc6','title'=>'第六名'],
					['playid'=>'pk10mc7','title'=>'第七名'],
					['playid'=>'pk10mc8','title'=>'第八名'],
					['playid'=>'pk10mc9','title'=>'第九名'],
					['playid'=>'pk10mc10','title'=>'第十名'],
				],
			],
			'dxds' => [
				'title'=>'大小单双',
				'list'=>[
					['playid'=>'pk10dxds','title'=>'大小单双'],
				],
			],
			'pk10lhd'=>[
				'title'=>'龙虎',
                'list'=>[
                    ['playid'=>'pk10lhd','title'=>'龙虎'],
                ],
			],
			/*'dx'=>[
                'title'=>'大小',
		...
		$k3 = [
			...
			'k3hzzx'=>[
				...
				'list'=>[
					...
					['playid'=>'k3hzbigodd','rate'=>'1.95','title'=>'大单'],
					['playid'=>'k3hzsmallodd','rate'=>'1.95','title'=>'小单'],
					['playid'=>'k3hzbigeven','rate'=>'1.95','title'=>'大双'],
					['playid'=>'k3hzsmalleven','rate'=>'1.95','title'=>'小双'],
				],
			],
			'三军/大小'=>[
				'title'=>'三军/大小',
				'list'=>[
					['playid'=>'sjdx1','rate'=>'1.98','title'=>'1'],
					['playid'=>'sjdx2','rate'=>'1.98','title'=>'2'],
					['playid'=>'sjdx3','rate'=>'1.98','title'=>'3'],
					['playid'=>'sjdx4','rate'=>'1.98','title'=>'4'],
					['playid'=>'sjdx5','rate'=>'1.98','title'=>'5'],
					['playid'=>'sjdx6','rate'=>'1.98','title'=>'6'],
					['playid'=>'sjdxd','rate'=>'1.98','title'=>'大'],
					['playid'=>'sjdxs','rate'=>'1.98','title'=>'小'],
				],
			],
			'围骰/全骰'=>[
				'title'=>'围骰/全骰',
				'list'=>[
					['playid'=>'wsqs111','rate'=>'1.98','title'=>'111'],
					['playid'=>'wsqs222','rate'=>'1.98','title'=>'222'],
					['playid'=>'wsqs333','rate'=>'1.98','title'=>'333'],
					['playid'=>'wsqs444','rate'=>'1.98','title'=>'444'],
					['playid'=>'wsqs555','rate'=>'1.98','title'=>'555'],
					['playid'=>'wsqs666','rate'=>'1.98','title'=>'666'],
					['playid'=>'wsqsqqq','rate'=>'1.98','title'=>'全骰'],
				],
			],
			'点数'=>[
				'title'=>'点数',
				'list'=>[
					['playid'=>'ds4','rate'=>'1.98','title'=>'4'],
					['playid'=>'ds5','rate'=>'1.98','title'=>'5'],
					['playid'=>'ds6','rate'=>'1.98','title'=>'6'],
					['playid'=>'ds7','rate'=>'1.98','title'=>'7'],
					['playid'=>'ds8','rate'=>'1.98','title'=>'8'],
					['playid'=>'ds9','rate'=>'1.98','title'=>'9'],
					['playid'=>'ds10','rate'=>'1.98','title'=>'10'],
					['playid'=>'ds11','rate'=>'1.98','title'=>'11'],
					['playid'=>'ds12','rate'=>'1.98','title'=>'12'],
					['playid'=>'ds13','rate'=>'1.98','title'=>'13'],
					['playid'=>'ds14','rate'=>'1.98','title'=>'14'],
					['playid'=>'ds15','rate'=>'1.98','title'=>'15'],
					['playid'=>'ds16','rate'=>'1.98','title'=>'16'],
					['playid'=>'ds17','rate'=>'1.98','title'=>'17'],
				],
			],
			'长牌'=>[
				'title'=>'长牌',
				'list'=>[
					['playid'=>'cp12','rate'=>'1.98','title'=>'12'],
					['playid'=>'cp13','rate'=>'1.98','title'=>'13'],
					['playid'=>'cp14','rate'=>'1.98','title'=>'14'],
					['playid'=>'cp15','rate'=>'1.98','title'=>'15'],
					['playid'=>'cp16','rate'=>'1.98','title'=>'16'],
					['playid'=>'cp23','rate'=>'1.98','title'=>'23'],
					['playid'=>'cp24','rate'=>'1.98','title'=>'24'],
					['playid'=>'cp25','rate'=>'1.98','title'=>'25'],
					['playid'=>'cp26','rate'=>'1.98','title'=>'26'],
					['playid'=>'cp34','rate'=>'1.98','title'=>'34'],
					['playid'=>'cp35','rate'=>'1.98','title'=>'35'],
					['playid'=>'cp36','rate'=>'1.98','title'=>'36'],
					['playid'=>'cp45','rate'=>'1.98','title'=>'45'],
					['playid'=>'cp46','rate'=>'1.98','title'=>'46'],
					['playid'=>'cp56','rate'=>'1.98','title'=>'56'],
				],
			],
			'短牌'=>[
				'title'=>'短牌',
				'list'=>[
					['playid'=>'dp11','rate'=>'1.98','title'=>'11'],
					['playid'=>'dp22','rate'=>'1.98','title'=>'22'],
					['playid'=>'dp33','rate'=>'1.98','title'=>'33'],
					['playid'=>'dp44','rate'=>'1.98','title'=>'44'],
					['playid'=>'dp55','rate'=>'1.98','title'=>'55'],
					['playid'=>'dp66','rate'=>'1.98','title'=>'66'],
				],
			],
			'红黑码'=>[
				'title'=>'红黑码',
				'list'=>[
					['playid'=>'hhmhong','rate'=>'1.98','title'=>'红码'],
					['playid'=>'hhmhei','rate'=>'1.98','title'=>'黑码'],
					['playid'=>'hhmhongd','rate'=>'1.98','title'=>'红码大'],
					['playid'=>'hhmhongx','rate'=>'1.98','title'=>'红码小'],
					['playid'=>'hhmhongdd','rate'=>'1.98','title'=>'红码单'],
					['playid'=>'hhmhongss','rate'=>'1.98','title'=>'红码双'],
					['playid'=>'hhmheid','rate'=>'1.98','title'=>'黑码大'],
					['playid'=>'hhmheix','rate'=>'1.98','title'=>'黑码小'],
					['playid'=>'hhmheidd','rate'=>'1.98','title'=>'黑码单'],
					['playid'=>'hhmheixx','rate'=>'1.98','title'=>'黑码双'],
					['playid'=>'hhmhong4hong','rate'=>'1.98','title'=>'四码红'],
					['playid'=>'hhmhong4hei','rate'=>'1.98','title'=>'四码黑'],
					['playid'=>'hhmhong5hei','rate'=>'1.98','title'=>'五码黑'],
				],
			],
		];
		return $k3;
	...
	function x5(){
		$x5 = [
			...
			'x5hz'=>[
				'title'=>'和值',
				'list'=>[
					['playid'=>'x5qshz','title'=>'前三和值'],
					['playid'=>'x5zshz','title'=>'中三和值'],
					['playid'=>'x5hshz','title'=>'后三和值'],
				],
			],
		];
		return $x5;
	...
	function ssc(){
		$ssc = [
			...
			'zhlh'=>[
				'title'=>'总和/龙虎',
				'list'=>[
					['playid'=>'zhlhzhd','title'=>'总和大'],
					['playid'=>'zhlhzhx','title'=>'总和小'],
					['playid'=>'zhlhzhdd','title'=>'总和单'],
					['playid'=>'zhlhzhss','title'=>'总和双'],
					['playid'=>'zhlhl','title'=>'龙'],
					['playid'=>'zhlhh','title'=>'虎'],
					['playid'=>'zhlhhe','title'=>'和'],
				],
			],
			'sscww'=>[
				'title'=>'万位',
				'list'=>[
					['playid'=>'sscwwd','title'=>'大'],
					['playid'=>'sscwwx','title'=>'小'],
					['playid'=>'sscwwdd','title'=>'单'],
					['playid'=>'sscwwss','title'=>'双'],
					['playid'=>'sscwwz','title'=>'质'],
					['playid'=>'sscwwh','title'=>'合'],
					['playid'=>'sscwwn','title'=>'数字'],
				],
			],
			'sscqw'=>[
				'title'=>'仟位',
				'list'=>[
					['playid'=>'sscqwd','title'=>'大'],
					['playid'=>'sscqwx','title'=>'小'],
					['playid'=>'sscqwdd','title'=>'单'],
					['playid'=>'sscqwss','title'=>'双'],
					['playid'=>'sscqwz','title'=>'质'],
					['playid'=>'sscqwh','title'=>'合'],
					['playid'=>'sscqwn','title'=>'数字'],
				],
			],
			'sscbw'=>[
				'title'=>'佰位',
				'list'=>[
					['playid'=>'sscbwd','title'=>'大'],
					['playid'=>'sscbwx','title'=>'小'],
					['playid'=>'sscbwdd','title'=>'单'],
					['playid'=>'sscbwss','title'=>'双'],
					['playid'=>'sscbwz','title'=>'质'],
					['playid'=>'sscbwh','title'=>'合'],
					['playid'=>'sscbwn','title'=>'数字'],
				],
			],
			'sscsw'=>[
				'title'=>'拾位',
				'list'=>[
					['playid'=>'sscswd','title'=>'大'],
					['playid'=>'sscswx','title'=>'小'],
					['playid'=>'sscswdd','title'=>'单'],
					['playid'=>'sscswss','title'=>'双'],
					['playid'=>'sscswz','title'=>'质'],
					['playid'=>'sscswh','title'=>'合'],
					['playid'=>'sscswn','title'=>'数字'],
				],
			],
			'sscgw'=>[
				'title'=>'个位',
				'list'=>[
					['playid'=>'sscgwd','title'=>'大'],
					['playid'=>'sscgwx','title'=>'小'],
					['playid'=>'sscgwdd','title'=>'单'],
					['playid'=>'sscgwss','title'=>'双'],
					['playid'=>'sscgwz','title'=>'质'],
					['playid'=>'sscgwh','title'=>'合'],
					['playid'=>'sscgwn','title'=>'数字'],
				],
			],
			'ssclhd'=>[
                'title'=>'龙虎',
                'list'=>[
                    ['playid'=>'ssclhdwql','title'=>'万仟龙'],
                    ['playid'=>'ssclhdwqh','title'=>'万仟虎'],
                    ['playid'=>'ssclhdwqhe','title'=>'万仟和'],

                    ['playid'=>'ssclhdwbl','title'=>'万佰龙'],
                    ['playid'=>'ssclhdwbh','title'=>'万佰虎'],
                    ['playid'=>'ssclhdwbhe','title'=>'万佰和'],

                    ['playid'=>'ssclhdwsl','title'=>'万拾龙'],
                    ['playid'=>'ssclhdwsh','title'=>'万拾虎'],
                    ['playid'=>'ssclhdwshe','title'=>'万拾和'],

                    ['playid'=>'ssclhdwgl','title'=>'万个龙'],
                    ['playid'=>'ssclhdwgh','title'=>'万个虎'],
                    ['playid'=>'ssclhdwghe','title'=>'万个和'],

                    ['playid'=>'ssclhdqbl','title'=>'仟佰龙'],
                    ['playid'=>'ssclhdqbh','title'=>'仟佰虎'],
                    ['playid'=>'ssclhdqbhe','title'=>'仟佰和'],

                    ['playid'=>'ssclhdqsl','title'=>'仟拾龙'],
                    ['playid'=>'ssclhdqsh','title'=>'仟拾虎'],
                    ['playid'=>'ssclhdqshe','title'=>'仟拾和'],

                    ['playid'=>'ssclhdqgl','title'=>'仟个龙'],
                    ['playid'=>'ssclhdqgh','title'=>'仟个虎'],
                    ['playid'=>'ssclhdqghe','title'=>'仟个和'],

                    ['playid'=>'ssclhdbsl','title'=>'佰拾龙'],
                    ['playid'=>'ssclhdbsh','title'=>'佰拾虎'],
                    ['playid'=>'ssclhdbshe','title'=>'佰拾和'],

                    ['playid'=>'ssclhdbgl','title'=>'佰个龙'],
                    ['playid'=>'ssclhdbgh','title'=>'佰个虎'],
                    ['playid'=>'ssclhdbghe','title'=>'佰个和'],

                    ['playid'=>'ssclhdsgl','title'=>'拾个龙'],
                    ['playid'=>'ssclhdsgh','title'=>'拾个虎'],
                    ['playid'=>'ssclhdsghe','title'=>'拾个和'],
                ],
            ],
			/*			
            */
