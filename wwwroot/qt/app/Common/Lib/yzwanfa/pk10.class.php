  ...
  //猜前一
   ...
   //多排号码过滤
    ...
    return $sarr;
  	...
  	function pk10gyhd($tzcode){
		if($tzcode!='和大')return 0;
		return 1;
	}
	function pk10gyhx($tzcode){
		if($tzcode!='和小')return 0;
		return 1;
	}
	function pk10gyhdd($tzcode){
		if($tzcode!='和单')return 0;
		return 1;
	}
	function pk10gyhss($tzcode){
		if($tzcode!='和双')return 0;
		return 1;
	}

	function pk10mc1($tzcode){
		return 1;
	}
	function pk10mc2($tzcode){
		return 1;
	}
	function pk10mc3($tzcode){
		return 1;
	}
	function pk10mc4($tzcode){
		return 1;
	}
	function pk10mc5($tzcode){
		return 1;
	}
	function pk10mc6($tzcode){
		return 1;
	}
	function pk10mc7($tzcode){
		return 1;
	}
	function pk10mc8($tzcode){
		return 1;
	}
	function pk10mc9($tzcode){
		return 1;
	}
	function pk10mc10($tzcode){
		return 1;
	}

	function pk10gyhz($tzcode){
		return 1;
	}

	function pk10gyhz3($tzcode){
		return 1;
	}

	function pk10gyhz4($tzcode){
		return 1;
	}
	function pk10gyhz5($tzcode){
		return 1;
	}
	function pk10gyhz6($tzcode){
		return 1;
	}
	function pk10gyhz7($tzcode){
		return 1;
	}
	function pk10gyhz8($tzcode){
		return 1;
	}
	function pk10gyhz9($tzcode){
		return 1;
	}
	function pk10gyhz10($tzcode){
		return 1;
	}
	function pk10gyhz11($tzcode){
		return 1;
	}
	function pk10gyhz12($tzcode){
		return 1;
	}
	function pk10gyhz13($tzcode){
		return 1;
	}
	function pk10gyhz14($tzcode){
		return 1;
	}
	function pk10gyhz15($tzcode){
		return 1;
	}
	function pk10gyhz16($tzcode){
		return 1;
	}
	function pk10gyhz17($tzcode){
		return 1;
	}
	function pk10gyhz18($tzcode){
		return 1;
	}
	function pk10gyhz19($tzcode){
		return 1;
	}

	function pk10dxds($tzcode){
		$tzcode = explode('|', $tzcode);
		$sum = 0;
		foreach ($tzcode as $val) {
			if(!empty($val)){
				$tz = explode(',', $val);
				$sum += count($tz);
			}
