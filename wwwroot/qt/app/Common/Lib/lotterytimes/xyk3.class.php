...
class xyk3 {
	function drawtimes(){
		...
		$return = [
			'lastFullExpect'  => $predraws['expect']+181,
			'lastExpect'      => substr($predraws['expect'],-$_length)+181,
			'currFullExpect'  => $nowdraws['expect']+181,
			'currExpect'      => substr($nowdraws['expect'],-$_length)+181,
