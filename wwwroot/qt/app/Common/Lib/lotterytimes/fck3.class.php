...
class fck3 {
	function drawtimes(){
		...
		$return = [
			'lastFullExpect'  => $predraws['expect']+79,
			'lastExpect'      => substr($predraws['expect'],-$_length)+79,
			'currFullExpect'  => $nowdraws['expect']+79,
			'currExpect'      => substr($nowdraws['expect'],-$_length)+79,
