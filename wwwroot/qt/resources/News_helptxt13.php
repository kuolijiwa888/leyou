    ...
    <div class="subPageMain">
     <div class="sub-page">
      <div class="page-container helpCenter">
       ...
       <article>
        <h4>激活产品</h4> 
        <p>首次进入游戏时自动激活，若有无法激活的问题请稍后再试或者咨询在线客服。</p>
      </article> 
      <article>
        <h4>转账流程</h4> 
        <p><span>1</span>于页面右上点选转账或财务中心 ＞ 平台转账<br /> <span>2</span>选择转出、转入的产品类型，并输入转账金额确认转账送出 </p>
      </article> 
      <aside>
        <div>
         <button type="button" onclick="location.href='/byhelp'" class="el-button el-button--primary el-button--medium is-plain">
      ...
      <dd>
        <a href="/byhelp/helptxt14" class="">产品介绍</a>
      </dd> 
      <dd>
