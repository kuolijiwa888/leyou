	...
	<div class="sub-container">
		<div class="subPagNav">
			...
			<div class="navl2">
				...
				<span><a href="javascript:vodi(0)" class="router-link-exact-active router-link-active">个人账变明细</a></span> 
				...
				<div class="page-container">
					<form class="el-form el-form--inline">
						<div class="el-row">
							<div class="el-form-item el-form-item--small">
								<div class="el-form-item__content">
									<div class="el-select el-select--small" style="width: 154px;" name="el-select">
										<div class="el-input el-input--small el-input--suffix">
											<input type="text" readonly="readonly"  id="imgtalk" value="全部摘要" class="el-input__inner form-control ty_select" />
											<!-- <select name="type" class="form-control ty_select el-input__inner" id="type">
								    ...
								    <div class="el-select-dropdown el-popper" style="display: none; min-width: 154px;">
								    	<div class="el-scrollbar">
								    		<div class="el-select-dropdown__wrap el-scrollbar__wrap">
								    			<ul class="el-scrollbar__view el-select-dropdown__list" name="type"id="type">
								    				<li class="el-select-dropdown__item addselected" value="0">全部摘要</li>
								    				<foreach name="typearray" item="t" key="k"> 
								    					<li class="el-select-dropdown__item <if condition="$k eq $type"> selected</if>" value="{$k}">{$t} </li>
								    				</foreach>
								    			</ul>
								    		</div>
						...
						<div style="display: inline-block;"class="el-row" id="atime">
							...
							<div class="el-form-item el-form-item--small">
								<div class="el-form-item__content">
									<a href="/tools/_ajax/queryBillRecord"><button type="button" class="el-button el-button--primary el-button--small">
										<span>账户明细</span>
									</button></a>
								</div>
							</div> 
								...
								<volist name="mxlist" id="vo">
									<tr class="el-table__row">
										...
										<td rowspan="1" colspan="1" class="el-table_8_column_61">
											<div class="cell">{$vo.amountafter}</div>
										</td>
...
<script>
	...
	$('.el-select-dropdown__item').click(function(){
	    ...
	    var url = "/tools/_ajax/queryBillRecords/"+atime+"/"+type;
