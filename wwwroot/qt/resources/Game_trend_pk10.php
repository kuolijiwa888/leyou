...
<body class="ssc-zst" ondragstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false" onselectstart="event.returnValue=false">
  ...
  <div class="trend_start">
    <!--走势图头部-->
    <div class="trend_top" style="width: 1444px;">
      <div class="chart-wrap0">
        <div class="chart-wrap1">
          <span>基本走势图</span>
          <div class="chart-daxuan">
            <input type="text" readonly="readonly" id="imgtalk" autocomplete="off" placeholder="PK拾" value="PK拾" class="byzs_input1">
              ...
              <div class="el-scrollbar"> 
                <div class="el-select-dropdown__wrap el-scrollbar__wrap"> 
                  <ul class="el-scrollbar__view el-select-dropdown__list" name="type" id="type"> 
                    ...
                    <li class="el-select-dropdown__item allcpname selected" value="/gameChart/trend_pk10/pk101">PK拾</li>
        ...
        <div class="chart-wrap3">
          <button class="<if condition="$Think.get.type eq '1'">active</if>" type="1"><span>前五名</span></button>
          <button class="<if condition="$Think.get.type eq '2'">active</if>" type="2"><span>后五名</span></button>
        </div>
      </div>
    </div>
    ...
    <div class="chart">
      <div class="chart-bottom">
        <div class="chart-wrap" style="width: 1444px;">
          <table class="chart-table" chartsTable>
            ...
            <tbody id="cpdata">
              ...
              <tr style="border-bottom: 1px solid #e0e0e0;background-color: #252525;color: #fff;">
                ...
                <td class="title-k3-xt" rowspan="2">冠军大小</td>
                <td class="title-k3-xt" rowspan="2">冠军单双</td>
  ...
  <script>
    ...
    $('.chart-wrap3 button').click(function(){
    ...
    $('.cpdataname').click(function(){
      ...
      $('#imgtalk1').val(text);
      var url = "/gameChart/trend_pk10/"+cpdataname;
      window.location.href= url;
    })
  </script>
