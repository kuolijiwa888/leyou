        ...
        function Betting_recordlist(data, initcond, _InitCallback) {
            ...
            if (data.Code != undefined && data.Code == "1") {
                ...
                for (var i = 0 ; i < _TrData.length ; i++) {
                    ...
                    strVar += " <td class='c_org'>" + parseFloat(_TrData[i].normal_money).toFixed(3) + "</td>";
    ...
    if ($("#invest_fuddetail_cont").size() > 0) {
        ...
        function invest_fuddetailList(data, initcond, _InitCallback) {
            ...
            if ((data.code != undefined && data.code == "1") || (data.Code != undefined && data.Code == "1")) {
                ...
                for (var i = 0 ; i < _TrData.length ; i++) {
                    var InMoneys = isNaN(parseFloat(_TrData[i].InMoney).toFixed(3)) ? _TrData[i].InMoney : parseFloat(_TrData[i].InMoney);
                    var OutMoney = isNaN(parseFloat(_TrData[i].OutMoney).toFixed(3)) ? _TrData[i].OutMoney : parseFloat(_TrData[i].OutMoney);
                    var Money = isNaN(parseFloat(_TrData[i].Money).toFixed(3)) ? _TrData[i].Money : parseFloat(_TrData[i].Money);
                    var strVar = "";
                    strVar += "<tr>";
 ...
 */
        ...
        function Proxy_IndexlList(data, initcond, _InitCallback) {
            if (data.Code == "1") {
                ...
                if (_Today_len > 0) {
                    ...
                    $("#p_buy").empty().text(parseFloat(p_buy).toFixed(3));
                    $("#p_load").empty().text(parseFloat(p_load).toFixed(3));
                    $("#p_withdraw").empty().text(parseFloat(p_withdraw).toFixed(3));
                    $("#p_rebates").empty().text(parseFloat(p_rebates).toFixed(3));
        ...
        function HeMai_ContListFn(data, initcond, _InitCallback) {
            ...
            if (data.Code != undefined && data.Code == "1" && data.Data != null) {
                ...
                for (var i = 0 ; i < _TrData.length ; i++) {
                    ...
                    strVar += "    <span class='SolutPrice'>" + parseFloat(_TrData[i].schemeMoney).toFixed(3) + "&nbsp;|&nbsp;" + parseFloat(_TrData[i].money).toFixed(3) + "</span> ";
    ...
    if ($("#join_with_buy").size() > 0) {
        ...
        $("#join_with_buy #buy_numb").keyup(function (event) {
            ...
            var buyPrice = parseFloat(theEachMoney * theValue).toFixed(3);
    ...
    if ($("#invest_fuddetail_cont_2").size() > 0) {
        ...
        function invest_fuddetailList2(data, initcond, _InitCallback) {
            ...
            if (data.Code != undefined && data.Code == "1") {
                ...
                for (var i = 0 ; i < _TrData.length ; i++) {
                    var InMoneys = isNaN(parseFloat(_TrData[i].money).toFixed(3)) ? _TrData[i].money : parseFloat(_TrData[i].money).toFixed(3);
                    var OutMoney = isNaN(parseFloat(_TrData[i].dmoney).toFixed(3)) ? _TrData[i].dmoney : parseFloat(_TrData[i].dmoney).toFixed(3);
    ...
    if ($("#invest_fuddetail_cont_3").size() > 0) {
        ...
        function invest_fuddetailList3(data, initcond, _InitCallback) {
            ...
            if (data.Code != undefined && data.Code == "1") {
                ...
                if (_TrData.length >= 0 || _TrData == null) { $("#fudetail_list2").empty(); }
                for (var i = 0 ; i < _TrData.length ; i++) {
                    var InMoneys = isNaN(parseFloat(_TrData[i].InMoney).toFixed(3)) ? _TrData[i].InMoney : parseFloat(_TrData[i].InMoney).toFixed(3);
                    var OutMoney = isNaN(parseFloat(_TrData[i].OutMoney).toFixed(3)) ? _TrData[i].OutMoney : parseFloat(_TrData[i].OutMoney).toFixed(3);
                    var Money = isNaN(parseFloat(_TrData[i].Money).toFixed(3)) ? _TrData[i].Money : parseFloat(_TrData[i].Money).toFixed(3);
                    var strVar = "";
                    strVar += "<tr>";
