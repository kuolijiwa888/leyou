...
$(function () {
  ...
  lotteryname = null;
	...
	if(lotteryurl.substr(lotteryurl.length-1,1)!=1||lotteryurl.substring(lotteryurl.lastIndexOf("\/")+1, lotteryurl.length)!=1){
		lotteryname = lotteryurl.substring(lotteryurl.lastIndexOf("\/")+1, lotteryurl.length);
...
function ctSubmit(){
	...
	$(".bet-input").each(function(){
		...
		if(val > 0){
			...
			addtotouzhu(playid,dataval,1,1,val,val);
		}
	});
    ...
    $('.dialog-footer .el-button--default').click(function () {
        $('.el-dialog__wrapper').removeClass("ascnshow");
        $('.el-dialog__wrapper').addClass("ascnhide");
        window.setTimeout(function () {
            $('.el-dialog__wrapper').hide();
            $('.el-dialog__wrapper').removeClass("ascnhide");
            $('.el-dialog__wrapper').addClass("ascnshow");
...
var addtotouzhu = function(_playid,number,zhushu,isshow,minxf,beishu){
	...
	if($Detailnode.length>0){
		...
		var array = { 
			...
			'maxzs':rate.maxzs,
			'rate':rate.maxjj,
            'beishu':beishu?parseInt(beishu):1
		}; 
...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<div class="lotterys"><div class="rq">'+openinfo.expect+'</div><div class="hm"><span class="qiu">'+array[0]+'</span><span class="qiu">'+array[1]+'</span><span class="qiu">'+array[2]+'</span><span class="qiu">'+array[3]+'</span><span class="qiu">'+array[4]+'</span><span class="qiu">'+array[5]+'</span><span class="qiu">'+array[6]+'</span><span class="qiu">'+array[7]+'</span><span class="qiu">'+array[8]+'</span><span class="qiu">'+array[9]+'</span></div></div>';
