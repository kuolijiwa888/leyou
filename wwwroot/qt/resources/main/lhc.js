...
/*		var data = {
		...
		if(data.sign==true){
			...
			for(var o in lotlist){
				...
				html += '<div class="lotterys"><div class="rq">'+openinfo.expect+'</div><div class="hm"><span class="qiu">'+array[0]+'</span><span class="qiu">'+array[1]+'</span><span class="qiu">'+array[2]+'</span><span class="qiu">'+array[3]+'</span><span class="qiu">'+array[4]+'</span><span class="qiu">'+array[5]+'</span><span class="qiu">'+array[6]+'</span></div></div>';
