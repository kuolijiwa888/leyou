	...
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_logo">
            ...
            <a href="javascript:void(0)" >
                <i  class="" > <img  style="width:70px;" src="__ROOT__/resources/images/111.png"></i>
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
        ...
        <div class="cz_openNumb">
			...
			<ol class="lhc_sxTextUl"  style="display:none;">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<div class="selectMultiple">
					...
					<div class="selectMultipleNumber" style="display: none;">
						<i class="reduce">-</i>
						<input type="tel" value="0" class="selectMultipInput" onChange="return (/[\d]/.test(String.fromCharCode(event.keyCode)))">
						<i class="add">+</i>
					</div>
					<!-- 倍 -->
