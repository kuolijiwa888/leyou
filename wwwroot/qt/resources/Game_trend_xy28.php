...
<body class="ssc-zst">
  ...
  <div class="trend_start">
    <!--走势图头部-->
    <div class="trend_top" style="width: 1584px;">
      <div class="chart-wrap0">
        <div class="chart-wrap1">
          <span>基本走势图</span>
          <div class="chart-daxuan">
            <input type="text" readonly="readonly" id="imgtalk" autocomplete="off" placeholder="幸运28" value="幸运28" class="byzs_input1">
              ...
              <div class="el-scrollbar"> 
                <div class="el-select-dropdown__wrap el-scrollbar__wrap"> 
                  <ul class="el-scrollbar__view el-select-dropdown__list" name="type" id="type"> 
                    ...
                    <li class="el-select-dropdown__item allcpname selected" value="/gameChart/trend_xy28/xy28">幸运28</li>
    ...
    <div class="chart">
      <div class="chart-bottom">
        <div class="chart-wrap" style="width: 1584px;">
          <table class="chart-table">
            <thead>
              <tr>
                ...
                <td class="chart-pos-title" colspan="10">
                  <div>第一位</div>
                </td>
                <td class="chart-pos-title" colspan="10">
                  <div>第二位</div>
                ...
                <td class="chart-pos-title" colspan="28">
                  <div>和值走势</div>
                </td>
                <td class="title-k3-xt" rowspan="2">和值大小</td>
                <td class="title-k3-xt" rowspan="2">和值单双</td>
                <td class="chart-distribution-title" colspan="10">
                  <div>号码分布</div>
                </td>
              </tr>
  ...
  <script>
    ...
    $('#zxian').click(function(){
      ...
      if($('#addCanvas1').css('display')=="none"){
        $('#addCanvas1').css('display','block')
        $(this).addClass('ant-checkbox-checked');
      }else{
        $('#addCanvas1').css('display','none');
        $(this).removeClass('ant-checkbox-checked');
      }
    })
    ...
    $('.cpdataname').click(function(){
      ...
      $('#imgtalk1').val(text);
      var url = "/gameChart/trend_xy28/"+cpdataname;
      window.location.href= url;
    })
  </script>
  <script type="text/javascript">
        ...
        function fromRight(obj) {
          ...
          var num = (<if condition="$Think.get.num eq '30'">30<elseif condition="$Think.get.num eq '50'"/>50<elseif condition="$Think.get.num eq '100'"/>100<else />30</if>-1)*5
            ...
            var direction = brr[i].offsetLeft - brr[i + 3].offsetLeft;
            //获取本期的中奖号码第一位与下一期中奖号码第一位两球外框单元格的上边的距离绝对值
            chartsObj.disHeight = Math.abs(brr[i].offsetTop - brr[i + 3].offsetTop)-15
            //获取本期的中奖号码第一位与下一期中奖号码第一位两球外框单元格的左侧的距离绝对值
            chartsObj.disWidth = Math.abs(brr[i].offsetLeft - brr[i + 3].offsetLeft)
            //获取球外框单元格的自身高度
        ...
        function fromRight(obj) {
          ...
          var brr = $(".byzstxt .selected-num_k3").parent();
          ...
          var num = (<if condition="$Think.get.num eq '30'">30<elseif condition="$Think.get.num eq '50'"/>50<elseif condition="$Think.get.num eq '100'"/>100<else />30</if>-1)*5
            ...
            for (var i = 0; i <num; i++) {
            // 判断本期的中奖号码第一位数与下一期中奖号码第一位数谁大谁小
            var direction = brr[i].offsetLeft - brr[i + 1].offsetLeft;
            //获取本期的中奖号码第一位与下一期中奖号码第一位两球外框单元格的上边的距离绝对值
            chartsObj.disHeight = Math.abs(brr[i].offsetTop - brr[i + 1].offsetTop)-15
            //获取本期的中奖号码第一位与下一期中奖号码第一位两球外框单元格的左侧的距离绝对值
            chartsObj.disWidth = Math.abs(brr[i].offsetLeft - brr[i + 1].offsetLeft)
            //获取球外框单元格的自身高度
            chartsObj.selfW = brr[i].clientWidth;
            //获取球外框单元格的自身宽度
            chartsObj.selfH = brr[i].clientHeight;
