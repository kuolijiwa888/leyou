	...
	<div class="container-fluid">
		...
		<ul class="set_list bankPass_list">
			<li class="clearfix">
				...
				<a class="set_btn pull-right" href="/verifySafePwd">立即找回</a>
			</li>
			<li class="clearfix">
				...
				<a class="set_btn pull-right" href="/find_safepass_phone">立即找回</a>
			</li>
<!--			<li class="clearfix">
			...
			<li class="clearfix">
				...
				<a class="set_btn pull-right" href="/find_safepass_email">立即找回</a>
			</li>
			<li class="clearfix">
				...
				<a class="set_btn pull-right" href="/find_safepass_qq">立即找回</a>
			</li>
		</ul>
	</div>
	</div>
