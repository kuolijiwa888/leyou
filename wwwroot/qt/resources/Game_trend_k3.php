...
<body class="ssc-zst">
  ...
  <div class="trend_start">
    <!--走势图头部-->
    <div class="trend_top" style="width: 1024px;">
      <div class="chart-wrap0" style="width: 850px;">
        <div class="chart-wrap1">
          <span>基本走势图</span>
          <div class="chart-daxuan">
            <input type="text" readonly="readonly" id="imgtalk" autocomplete="off" placeholder="快三" value="快三" class="byzs_input1">
              ...
              <div class="el-scrollbar"> 
                <div class="el-select-dropdown__wrap el-scrollbar__wrap"> 
                  <ul class="el-scrollbar__view el-select-dropdown__list" name="type" id="type"> 
                    ...
                    <li class="el-select-dropdown__item allcpname selected" value="/gameChart/trend_k3/f1k3">快三</li>
    ...
    <div class="chart">
      <div class="chart-bottom">
        <div class="chart-wrap" style="width: 1024px;">
          <table class="chart-table">
            <thead>
              <tr>
                ...
                <td class="chart-pos-title" colspan="6">
                  <div>第一位</div>
                </td>
                <td class="chart-pos-title" colspan="6">
                  <div>第二位</div>
                ...
                <td class="chart-pos-title" colspan="16">
                  <div>和值走势</div>
                </td>
                <td class="title-k3-xt" rowspan="2">和值大小</td>
                <td class="title-k3-xt" rowspan="2">和值单双</td>
                <td class="chart-distribution-title" colspan="6">
                  <div>号码分布</div>
                </td>
              </tr>
  ...
  <script>
    ...
    $('.cpdataname').click(function(){
      ...
      $('#imgtalk1').val(text);
      var url = "/gameChart/trend_k3/"+cpdataname;
      window.location.href= url;
    })
  </script>
