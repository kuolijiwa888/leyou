    ...
    <div class="pull-right vip_info_pan">
        ...
        <div class="vip_info_content security_main">
            ...
            <div class="text">
                ...
                <p>上次登录： {$Think.session.lastlogin.lasttime} , IP：{$Think.session.lastlogin.lastip}，{$Think.session.lastlogin.login_address} | 不是我登录？<a href="/verifyPwd" class="">修改密码</a></p>
            </div>
            <ul class="set_list">
                <li class="clearfix">
                    ...
                    <a class="set_btn pull-right" href="/verifyPwd">修改密码</a>
                </li>
                <li class="clearfix">
                    ...
                    <div class="set_list_column">
                        ...
                        <a class="set_btn pull-right" href="/verifySafePwd">修改资金密码</a>
                        <a class="set_btn pull-right" href="/ResetSafePwd">找回资金密码</a>
                ...
                <li class="clearfix">
                    ...
                    <notempty name="userinfo.tel">
                        <a class="set_btn pull-right" href="/ResetPhone">已绑定保手机</a>
                        <else />
                        <a class="set_btn pull-right" href="/ResetPhone">绑定密保手机</a>
                    </notempty>
...
<!--                <li class="clearfix">
                ...
                <li class="clearfix">
                    ...
                    <notempty name="userinfo.email">
                        <a class="set_btn pull-right" href="/Bindmail">修改密保邮箱</a>
                        <else />
                        <a class="set_btn pull-right" href="/Bindmail">绑定密保邮箱</a>
                    </notempty>
