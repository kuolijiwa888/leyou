	...
	<div class="sub-container">
		<div class="subPagNav">
			...
			<div class="navl2">
				...
				<span><a href="javascript:vodi(0)" class="router-link-exact-active router-link-active">个人充值记录</a></span> 
					...
					<form class="el-form el-form--inline">
						<div class="el-row">
											...
											<div class="el-scrollbar">
												<div class="el-select-dropdown__wrap el-scrollbar__wrap">
													<ul class="el-scrollbar__view el-select-dropdown__list" name="type"id="type">
														...
														<li class="el-select-dropdown__item <eq name="Think.get.state" value="1">selected</eq>" value="1">支付成功</li>
														<li class="el-select-dropdown__item <eq name="Think.get.state" value="0">selected</eq>" value="0">支付中</li>
														<li class="el-select-dropdown__item <eq name="Think.get.state" value="-1">selected</eq>" value="-1">订单关闭</li>
													</ul>
												</div>
							...
							<div style="display: inline-block;"class="el-row" id="atime">
								...
								<div class="el-form-item el-form-item--small">
									<div class="el-form-item__content">
										<a href="/tools/_ajax/queryRechargeRecord"><button type="button" class="el-button el-button--primary el-button--small">
											<span>充值记录</span>
										</button></a>
									</div>
								</div>
								<div class="el-form-item el-form-item--small">
									<div class="el-form-item__content">
										<a href="/tools/_ajax/queryWithdrawRecord"><button type="button" class="el-button el-button--small">
											<span>提现记录</span>
										</button></a>
									</div>
								</div>
									...
									<volist name="mxlist" id="vo">
										<tr class="el-table__row">
											...
											<td rowspan="1" colspan="1" class="el-table_8_column_61">
												<div class="cell">{$vo['paytypetitle']}</div>
											</td>
											<td rowspan="1" colspan="1" class="el-table_8_column_62">
												<div class="cell"><if condition="$vo['state'] eq 1"><span class="el-tag el-tag--info el-tag--mini">成功</span><elseif condition="$vo['state'] eq 0" /><span class="el-tag el-tag--info el-tag--mini">支付中</span><elseif condition="$vo['state'] eq -1" /><span class="el-tag el-tag--info el-tag--mini">订单关闭</span></if></div>
											</td>
										</tr>
									</volist>
								</tbody>
...
<include file="Public/footer" />
	...
	<script>
		...
		$('.el-select-dropdown__item').click(function(){
			...
			var url = "/dealrecord2/p/.atime."+atime+".state."+state;
			window.location.href= url;
		})
		function chaxun(t){
			var type = $('.el-scrollbar__view').find('.selected').attr('value');
			var state =  $('.el-scrollbar__view').find('.selected').attr('value');
			var url = "/dealrecord2/p/.atime."+t+".state."+state;
			window.location.href = url;
		}
	</script>
