     ...
     <div class="sub-page">
      <div class="page-container helpCenter">
       ...
       <section>
        ...
        <article>
          <h4>团队盈亏报表</h4> 
          <p>提供代理查询下级会员的投注概况，可依奖金、时间作分类查询。</p> 
          <p>代理可以透过掌握下级会员的销量、盈亏，以此作为调整会员奖金、配额的参考。</p> 
          <p><span>1</span>团队中心 ＞ 团队盈亏报表<br /> <span>2</span>查询下级会员，查看团队会员盈亏 </p>
        </article> 
        <article>
          <h4>团队账变明细</h4> 
          <p> 详细列出每一笔下级会员的资金讯息，可透过账变类型、账号、时间搜索下级会员的账变记录，若下级会员在账变上有疑虑可立即查询。 </p> 
          <p><span>1</span>团队中心 ＞ 团队账变明细<br /> <span>2</span>选择账变类型、下级用户、日期 </p>
        </article> 
        <aside>
          <div>
           <button type="button" onclick="location.href='/byhelp'" class="el-button el-button--primary el-button--medium is-plain">
