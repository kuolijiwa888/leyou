$(function () {
  ...
  function tabGameInit(){
    ...
    .html('从01-11共11个号码中选择3个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序一致，即为中奖，奖金。');
    $('.jiangjin').find('em[way-data="tabDoc"]')
    .html(rates.maxjj);
  ...
  function countFun(){
    switch(_thisPlayid){
      ...
      break;
      case 'x5qshz': case 'x5zshz': case 'x5hshz':
      zhushus.length = $('.g_Number_Section').find('.curr').length;
      break;
    }
  ...
  $('.bet_filter_box').on('click','.bet_options',function (){
    ...
    switch(_thisType){
      case 'x5qsfs':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择3个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序一致，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_x5qsfs,11,1);
      break;
      case 'x5qsds':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('手动输入3个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序一致，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5qszx':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择3个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序不限，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5qszxds':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('手动输入3个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前3个号码相同，且顺序不限，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5qsdt':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择3个以上号码进行投注，每注需至少包括1个胆码及2个拖码。只要当期的前三位开奖号码中有3个包含所选号码（每注包含3个号码），即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5qefs':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择2个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序一致，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5qeds':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('手动输入2个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序一致，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5qezx':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择2个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序不限，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5qezxds':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('手动输入2个号码组成一注，所输入的号码与当期顺序摇出的5个号码中 的前2个号码相同，且顺序不限，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5qedt':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择2个以上号码进行投注，每注需至少包括1个胆码及1个拖码。只要当期的前二位开奖号码中有2个包含所选号码（每注包含2个号码），即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5bdwqs':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择1个号码，每注由1个号码组成，只要当期顺序摇出的第一位、第二位、第三位开奖号码中包含所选号码。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5dwd':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从第一位、第二位、第三位任意1个位置或多个位置上选择1个号码，所选号码与相同位置上的开奖号码一致。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从6种单双个数组合中选择1种组合，当开奖号码的单双个数与所选单双组合一致。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html('<span class="moneyInfo">奖金详情</span>');
      addMoneyInfo(syxw_x5dds,rates.maxjj);
      gameNumberQw(syxw_x5dds);
      break;
      case 'x5czw':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从3-9中选择1个号码进行购买，所选号码与5个开奖号码按照大小顺序排列后的第3个号码相同，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx1z1':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择1个号码进行购买，当期的5个开奖号码中包含所选号码。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx2z2':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择2个号码进行购买，只要当期的5个开奖号码中包含所选号。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx3z3':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择3个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx4z4':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择4个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx5z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择5个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx6z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择6个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx7z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择7个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rx8z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中选择8个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5rxds1z1':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入1个号码进行购买，只要当期的5个开奖号码中包含所选号码。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5rxds2z2':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入2个号码进行购买，只要当期的5个开奖号码中包含所选号码。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5rxds3z3':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入3个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5rxds4z4':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入4个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5rxds5z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入5个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5rxds6z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入6个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5rxds7z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入7个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5rxds8z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11中手动输入8个号码进行购买，只要当期的5个开奖号码中包含所选号码，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      danshiNumberL = 2;
      danshiGame();
      ...
      case 'x5dt2z2':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择2个以上号码进行投注，每注需至少包括1个胆码及1个拖码。只要当期的5个开奖号码中有2个包含所选号码（每注包含2个号码），即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'x5dt3z3':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择3个以上号码进行投注，每注需至少包括1个胆码及2个拖码。只要当期的5个开奖号码中有3个包含所选号码（每注包含3个号码），即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_rxtd_x5dt2z2,11,1);
      break;
      case 'x5dt4z4':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择4个以上号码进行投注，每注需至少包括1个胆码及3个拖码。只要当期的5个开奖号码中有4个包含所选号码（每注包含4个号码），即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_rxtd_x5dt2z2,11,1);
      break;
      case 'x5dt5z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择5个以上号码进行投注，每注需至少包括1个胆码及4个拖码。只要所选的每注5个号码和当期的5个开奖号码全部相同，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_rxtd_x5dt2z2,11,1);
      break;
      case 'x5dt6z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择6个以上号码进行投注，每注需至少包括1个胆码及5个拖码。只要所选的每注6个号码当中，有5个和当期的5个开奖号码全部相同，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_rxtd_x5dt2z2,11,1);
      break;
      case 'x5dt7z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择7个以上号码进行投注，每注需至少包括1个胆码及6个拖码。只要所选的每注7个号码当中，有5个和当期的5个开奖号码全部相同，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_rxtd_x5dt2z2,11,1);
      break;
      case 'x5dt8z5':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从01-11共11个号码中至少选择8个以上号码进行投注，每注需至少包括1个胆码及7个拖码。只要所选的每注8个号码当中，有5个和当期的5个开奖号码全部相同，即为中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_rxtd_x5dt2z2,11,1);
      break;
      ...
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html('<span class="moneyInfo">奖金详情</span>');
      addMoneyInfo(syxw_x5qzhhz,rates.maxjj,'syxw_x5qzhhz');
      gameNumberQw(syxw_x5qzhhz);
      break;
    }
  })

function addMoneyInfo(text,money,type) {
  ...
  if(type == 'syxw_x5qzhhz'){
    html += '<tr><th>6/30</th><th>'+moneyList[0]+'</th></tr>';
    html += '<tr><th>7/29</th><th>'+moneyList[1]+'</th></tr>';
    html += '<tr><th>8/28</th><th>'+moneyList[2]+'</th></tr>';
    html += '<tr><th>9/27</th><th>'+moneyList[3]+'</th></tr>';
    html += '<tr><th>10/26</th><th>'+moneyList[4]+'</th></tr>';
    html += '<tr><th>11/25</th><th>'+moneyList[5]+'</th></tr>';
    html += '<tr><th>12/24</th><th>'+moneyList[6]+'</th></tr>';
    html += '<tr><th>13/23</th><th>'+moneyList[7]+'</th></tr>';
    html += '<tr><th>14/22</th><th>'+moneyList[8]+'</th></tr>';
    html += '<tr><th>15/21</th><th>'+moneyList[9]+'</th></tr>';
    html += '<tr><th>16/20</th><th>'+moneyList[10]+'</th></tr>';
    html += '<tr><th>17/19</th><th>'+moneyList[11]+'</th></tr>';
    html += '<tr><th>18</th><th>'+moneyList[12]+'</th></tr>';
    html += '<tr><th>大</th><th>'+moneyList[13]+'</th></tr>';
    html += '<tr><th>小</th><th>'+moneyList[14]+'</th></tr>';
    html += '<tr><th>单</th><th>'+moneyList[15]+'</th></tr>';
    html += '<tr><th>双</th><th>'+moneyList[16]+'</th></tr>';
  }else{
    for(var i in text){
...
function updateMaxJJ() {
  ...
  for(var j = 0; j < MaxJJ.length; j++){
    newnewmaxJJs = (MaxJJ[j] * beishusss).toFixed(3);
    if(j == MaxJJ.length - 1){
...
function xselectRmb(moneyStr,selectRmb) {
  ...
  for( var i = 0; i < moneyListArr.length; i++){
    if(i == moneyListArr.length - 1){
      moneyListStr += (moneyListArr[i] * selectRmb).toFixed(3);
    }else{
      moneyListStr += (moneyListArr[i] * selectRmb).toFixed(3) + '|';
    }
  }
  ...
  $('.addtobetbtn').on('click',function (){
    ...
    var Numbers = '';
    var winningMoney = $('.jiangjin').find('em[way-data="tabDoc"]').text();
    ...
    if(zhushus.length >= 1){
      ...
      if(bool){
        ...
        if(_thisPlayid == 'x5qshz' || _thisPlayid == 'x5zshz' || _thisPlayid == 'x5hshz'){
          var x5qzhshz = {
            '6': '0',
            '7': '1',
            '8': '2',
          ...
          for (var i in Numbersh) {
            rate = yrates[_thisPlayid];
            var minjj = rate.minjj;
            minjj = minjj.split('|');
            var arr = {
              'trano': trano,
              ...
              'maxjj': minjj[x5qzhshz[Numbersh[i]]],
              'minjj': minjj[x5qzhshz[Numbersh[i]]],
              'maxzs': rate.maxzs,
              'rate': minjj[x5qzhshz[Numbersh[i]]],
              'beishu': parseInt(times),
              'yjf' : selectRmb
            }
            winningMoneys = times*selectRmb*minjj[x5qzhshz[Numbersh[i]]];
            orderList.push(arr);
            var html = '<dd class="yBettingList" id="'+trano+'">'+
            '<div class="numberBox yBettingDiv">'+
            '<span class="number numberInfo"><div class="yBettingType">['+menu0+','+menu1+','+menu2+']</div> <em>'+Numbersh[i]+'</em></span>'+
            '</div>'+
            ...
            ''+selectRmbStr+''+
            '</div>'+
            '<div class="maxMoney yBettingDiv"style="width:120px;">'+
            '<em class="maxMoneyNumber">'+winningMoneys.toFixed(3)+'元</em>'+
            '</div>'+
          ...
          var html = '<dd class="yBettingList" id="'+trano+'">'+
          '<div class="numberBox yBettingDiv">'+
          '<span class="number numberInfo"><div class="yBettingType">['+menu0+','+menu1+','+menu2+']</div> <em>'+Numbers+'</em></span>'+
          '</div>'+
          '<div class="yBettingZhushu yBettingDiv">'+
          ...
          '<em class="maxMoneyNumber">'+winningMoneys.toFixed(3)+'元</em>'+
          '</div>'+
          '<div class="sc" style="display:inline-block;width: 97px;text-align: center;">'+
          '<a href="javascript:void(0);">'+
          '<i class="fa fa-times" style="color: #77777;"></i>'+
          '</a>'+
          '</div>'+
          '<div id="betting_money" style="display: none;">'+lastMoney+'</div>'+
          '</dd>';
  ...
  $(document).on("click", "#f_submit_order", function() {
    ...
    for (var i = 0; i < orderList.length; i++) {
      ...
      if(_thisPlayid == 'x5dds'){
        cur_numbers = cur_numbers.replace(/0/g,'五单零双');
        cur_numbers = cur_numbers.replace(/1/g,'四单一双');
        cur_numbers = cur_numbers.replace(/2/g,'三单二双');
        cur_numbers = cur_numbers.replace(/3/g,'二单三双');
        cur_numbers = cur_numbers.replace(/4/g,'一单四双');
        cur_numbers = cur_numbers.replace(/5/g,'零单五双');
      }
      Orderdetaillist +="<tr class='el-table__row'><td rowspan='1' colspan='1' class='el-table_3_column_21'><div class='cell'><span>"+menu0+'-'+menu1+'-'+menu2+"</span></div></td><td rowspan='1' colspan='1' class='el-table_3_column_22'><div class='cell'><span>"+cur_numbers+"</span></div></td><td rowspan='1' colspan='1' class='el-table_3_column_23'><div class='cell'>"+cur_order.zhushu+"注</div></td><td rowspan='1' colspan='1' class='el-table_3_column_24'><div class='cell'><span style='font-weight: bold; color: rgb(166, 143, 76);'>"+oprice.toFixed(3)+"</span></div></td></tr>";
    }
  ...
  $(document).on('click','#j_play_select li',function () {
    ...
    switch(this_attr){
      ...
      rates = yrates[_thisPlayid];
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('每位至少选择一个号码，竞猜开奖号码的全部五位，号码和位置都对应即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(syxw_x5qsfs,11,1);
      break;
...
function sortNumber(a,b){
  ...
  function checkNumber(string,len,clickObj){
    ...
    if(clickObj == 'remove'){
      if(string == ''){
        Dialog.error('温馨提示','请投注');
        return;
      }
      if(errArr.length < 1){
        Dialog.success('温馨提示','全部投注格式正确');
      }else{
        $('#text').val(yesString);
        Dialog.error('温馨提示','以下投注格式不正确： <br /> '+errString+'');
      }
    }
