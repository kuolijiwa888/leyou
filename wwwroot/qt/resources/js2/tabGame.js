$(function () {
  ...
  $('.bet_filter_box').on('click','.bet_options',function (){
    ...
    switch(_thisType){
      ...
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('每位至少选择一个号码，竞猜开奖号码的全部五位，号码和位置都对应即中奖。');
      $('.jiangjin').find('span[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_fs);
      break;
      case 'wxzhixds':
      ...
      case 'wxzxyel':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择五个号码投注，竞猜开奖号码的全部五位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'wxzxls':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择1个二重号码和3个单号号码组成一注，竞猜开奖号码的全部五位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_zx_60);
      break;
      case 'wxzxsl':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择2个二重号码和1个单号号码组成一注，竞猜开奖号码的全部五位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_zx_60);
      break;
      case 'wxzxel':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择1个三重号码和2个单号号码组成一注，竞猜开奖号码的全部五位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_zx_20);
      break;
      case 'wxzxyl':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择1个三重号码和1个二重号码组成一注，竞猜开奖号码的全部五位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_zx_10);
      break;
      case 'wxzxw':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择1个四重号码和1个单号号码组成一注，竞猜开奖号码的全部五位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_zx_5);
      break;
      case 'bdw5x1m':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择1个号码投注，竞猜开奖号码中包含这个号码，包含即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_bdw);
      break;
      case 'bdw5x2m':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择2个号码投注，竞猜开奖号码中包含这2个号码，包含即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_bdw);
      break;
      case 'bdw5x3m':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择3个号码投注，竞猜开奖号码中包含这3个号码，包含即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_bdw);
      break;
      ...
      case 'qwhscs':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择1个号码投注，竞猜开奖号码中包含这个号码且出现2次，即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(['好事成双']);
      break;
      case 'qwsxbx':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择1个号码投注，竞猜开奖号码中包含这个号码且出现3次，即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(['三星报喜']);
      break;
      case 'qwsjfc':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择1个号码投注，竞猜开奖号码中包含这个号码且出现4次，即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(['四季发财']);
      break;
      case 'sixzhixfsh':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('每位至少选择一个号码，竞猜开奖号码的后四位，号码和位置都对应即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(sx_fs);
      break;
      ...
      case 'hsizxes':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择4个号码投注，竞猜开奖号码的后4位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(sx_zx24);
      break;
      case 'hsizxye':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择1个二重号码和2个单号号码，竞猜开奖号码的后四位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(sx_zx12);
      break;
      case 'hsizxl':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择2个二重号码，竞猜开奖号码的后四位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(sx_zx6);
      break;
      case 'hsizxs':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('至少选择1个三重号码和1个单号号码，竞猜开奖号码的后四位，号码一致顺序不限即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(sx_zx4);
      break;
      case 'bdw4x1m':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择1个号码投注，竞猜开奖号码后四位中包含这个号码，包含即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(sx_bdw);
      break;
      case 'bdw4x2m':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从0-9中至少选择2个号码投注，竞猜开奖号码后四位中包含这2个号码，包含即中奖。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(sx_bdw);
      break;
      ...
      if(_thisType == 'sxzhixfsq'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('每位至少选择一个号码，竞猜开奖号码的前三位，号码和位置都对应即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
        gameNumber(q3_sxzhixfsq);
      }else if(_thisType == 'sxzhixfsz'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('每位至少选择一个号码，竞猜开奖号码的中三位，号码和位置都对应即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
        gameNumber(z3_sxzhixfsq);
      }else if(_thisType == 'sxzhixfsh'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('每位至少选择一个号码，竞猜开奖号码的后三位，号码和位置都对应即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      ...
      if(_thisType == 'zhixhzqs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码前三位数字之和。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zhixhzzs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码中三位数字之和。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zhixhzhs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码后三位数字之和。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'kuaduqs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('所选数值等于开奖号码的前3位最大与最小数字相减之差，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'kuaduzs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('所选数值等于开奖号码的中3位最大与最小数字相减之差，即是中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'kuaduhs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('所选数值等于开奖号码的后3位最大与最小数字相减之差，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'zuxhzqs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码前三位数字之和(不含豹子号)');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zuxhzzs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码中三位数字之和(不含豹子号)');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zuxhzhs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码后三位数字之和(不含豹子号)');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'sxzuxzsq'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中选择2个数字组成两注，所选号码与开奖号码的前三位相同，顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'sxzuxzsz'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中选择2个数字组成两注，所选号码与开奖号码的中三位相同，且顺序不限，即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'sxzuxzsh'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中选择2个数字组成两注，所选号码与开奖号码的后三位相同，且顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'sxzuxzlq'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择3个号码组成一注，所选号码与开奖号码的前三位相同，顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'sxzuxzlz'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择3个号码组成一注，所选号码与开奖号码的中三位相同，顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'sxzuxzlh'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择3个号码组成一注，所选号码与开奖号码的后三位相同，顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'sxhhzxq'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('手动输入号码，3个数字为一注，所选号码与开奖号码的前三位相同，顺序不限，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'sxhhzxz'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('手动输入号码，3个数字为一注，所选号码与开奖号码的中三位相同，顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'sxhhzxh'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('手动输入号码，3个数字为一注，所选号码与开奖号码的后三位相同，顺序不限，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      danshiNumberL = 3;
      ...
      if(_thisType == 'zuxcsbd'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择1个包胆号码，开奖号码的前三位中任意1位与所选包胆号码相同(不含豹子号)，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zuxzsbd'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择1个包胆号码，开奖号码的中三位中任意1位与所选包胆号码相同(不含豹子号)，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zuxhsbd'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择1个包胆号码，开奖号码的后三位中任意1位与所选包胆号码相同(不含豹子号)，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'qszsds'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('手动输入号码，3个数字为一注，所选号码与开奖号码的前三位相同，顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zszsds'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('手动输入号码，至少输入 1 个三位数号码。(三个数字当中有二个数字相同),顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'hszsds'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('手动输入号码，3个数字为一注，所选号码与开奖号码的后三位相同，顺序不限。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      danshiNumberL = 3;
      ...
      if(_thisType == 'bdwqs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中至少选择1个号码投注，竞猜开奖号码前三位中包含这个号码，包含即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'bdwzs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中至少选择1个号码投注，竞猜开奖号码中三位中包含这个号码，包含即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'bdwhs'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中至少选择1个号码投注，竞猜开奖号码后三位中包含这个号码，包含即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      gameNumber(q3_bdw);
      ...
      if(_thisType == 'bdwqs2m'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中至少选择2个号码投注，竞猜开奖号码前三位中包含这2个号码，包含即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'bdwzs2m'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中至少选择2个号码投注，竞猜开奖号码中三位中包含这2个号码。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'bdwhs2m'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中至少选择2个号码投注，竞猜开奖号码后三位中包含这2个号码，包含即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      gameNumber(q3_bdw);
      ...
      if(_thisType == 'exzhixfsq'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('每位至少选择一个号码，竞猜开奖号码的前二位，号码和位置都对应即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
        gameNumber(q2_exzhixfs);
      }else if(_thisType == 'exzhixfsh'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('每位至少选择一个号码，竞猜开奖号码的后二位，号码和位置都对应即中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      ...
      if(_thisType == 'zhixhzqe'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码前二位数字之和。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zhixhzhe'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('至少选择一个和值，竞猜开奖号码后二位数字之和。'); 
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'kuaduqe'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('所选数值等于开奖号码的前二位最大与最小数字相减之差，即为中奖。');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'kuaduhe'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('所选数值等于开奖号码的后二位最大与最小数字相减之差，即为中奖。'); 
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'exzuxfsq'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中选择2个数字组成一注，所选号码与开奖号码的前二位相同，顺序不限（不含对子）');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'exzuxfsh'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中选择2个数字组成一注，所选号码与开奖号码的后二位相同，顺序不限（不含对子）'); 
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'zuxhzqe'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('所选数值等于开奖号码的前二位数字相加之和（不含对子）');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zuxhzhe'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('所选数值等于开奖号码的后二位数字相加之和（不含对子）'); 
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      if(_thisType == 'zuxcebd'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择1个号码，开奖号码的前二位中任意1位包含所选的包胆号码相同（不含对子）');
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }else if(_thisType == 'zuxhebd'){
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
        .html('从0-9中任意选择1个号码，开奖号码的后二位中任意1位包含所选的包胆号码相同（不含对子）'); 
        $('.jiangjin').find('em[way-data="tabDoc"]')
        .html(rates.maxjj);
      }
      ...
      case 'dweid':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从万位、千位、百位、十位、个位任意位置上至少选择1个号码，选号与相同位置上的开奖号码一致');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      gameNumber(wx_fs);
      break;
      case 'dxdsqe':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'dxdshe':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从十位、个位中的“大、小、单、双”中至少各选一个组成一注。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'dxdsqs':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从万位、千位、百位中的“大、小、单、双”中至少各选一个组成一注。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
      ...
      case 'dxdshs':
      $('.play_select_prompt').find('span[way-data="tabDoc"]')
      .html('从百位、十位、个位中的“大、小、单、双”中至少各选一个组成一注。');
      $('.jiangjin').find('em[way-data="tabDoc"]')
      .html(rates.maxjj);
...
function gameNumberZxbd(arr,type){
  ...
  $('.addtobetbtn').on('click',function (){
    ...
    if(zhushus.length >= 1){
      ...
      if(bool){
        ...
        '</div>'+
        '<div class="sc" style="display: inline-block;text-align: center;width: 97px;">'+
        '<a href="javascript:void(0);">'+
        '<i class="fa fa-times" style="color: #777777;"></i>'+
        '</a>'+
        '</div>'+
  ...
  $(document).on("click", "#f_submit_order", function() {
    ...
    for (var i = 0; i < orderList.length; i++) {
      ...
      if(_thisPlayid == 'dxdsqe' || _thisPlayid == 'dxdshe' || _thisPlayid == 'dxdsqs' || _thisPlayid == 'dxdshs'){
        cur_numbers = cur_numbers.replace(/0/g,'大');
        cur_numbers = cur_numbers.replace(/1/g,'小');
        cur_numbers = cur_numbers.replace(/2/g,'单');
        cur_numbers = cur_numbers.replace(/3/g,'双');
    ...
    $('#daigoufooter .el-button--default').click(function () {
    ...
    $('#daigoufooter .el-button--primary').click(function () {
      $('.el-dialog').removeClass("ascnshow");
      $('.el-dialog').addClass("ascnhide");
      window.setTimeout(function () {
        $('#daigou').hide();
