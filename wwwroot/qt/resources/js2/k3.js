...
$(document).on("click", "#f_submit_order", function() {
	...
	for (var i = 0; i < orderList.length; i++) {
			...
			Orderdetaillist +="<p>"+rate.title+':<span class="mark">'+cur_order.number+'</span>&nbsp;&nbsp;注数:<span class="mark">'+cur_order.zhushu+'</span>&nbsp;&nbsp;金额:<span class="mark">'+oprice.toFixed(3)+"</span></p>";
	}
