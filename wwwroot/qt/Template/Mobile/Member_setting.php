...
<div class="security_h">
    ...
    <p class="security_h_ress"> IP：{$Think.session.lastlogin.lastip}，{$Think.session.lastlogin.login_address}  | <a href="/userCenter/verifyPwd">不是我登录?</a></p>
</div>

<ul class="my_set_list security_list">
    <li>
        <a href="/userCenter/verifyPwd" class="am-cf">
            <span>修改登录密码</span>
    ...
    <li>
        <?php  if(empty($userinfo['tradepassword'])){?><a href="/userCenter/setSafePwd" class="am-cf"><?php }else{?><a href="/userCenter/setSafePwd" class="am-cf"><?php }?>
...
<!--    <li>
    ...
    <li>
        <a href="/userCenter/manageBankcard" class="am-cf">
            <span>银行卡管理</span>
            <i class="iconfont icon-arrowright"></i>
