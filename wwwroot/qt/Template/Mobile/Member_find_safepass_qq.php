...
<body>
	...
	<div class="gaimi">
		<form action="/userCenter/find_qq" method="post" onsubmit="return checkform(this)">
			<div class="gaimi-top">
				<ul>
					<li>
						<div class="gaimi-top-name">QQ账号:</div>
						<div class="gaimi-top-mima"><input type="text" placeholder="请输入当前QQ账号" name="qq"></div>
					</li>
					<li>
