  ...
  <div class="mobileGameTop">
    <header data-am-widget="header"class="am-header am-header-default header nav_bg am-header-fixed" style="background:#000;">
      ...
      <h1 class="am-header-title userHome_h1" style="margin: 0 auto; width: 100%;">
		...
		<div data-v-048b2a82="" id="choseTab" class="choseTab forCtcpRecord" style="line-height: 2em;height: 2.2em;box-sizing: border-box;z-index:5;">
          <div data-v-048b2a82="" class="tabInner tabActive"><em data-v-048b2a82="">我要投注</em></div>
          <a href="/member.betrecord.do" data-v-048b2a82="" class="tabInner"><em data-v-048b2a82="">投注记录</em></a> 
          <span data-v-048b2a82="" class="wrapRefreshEye" style="color: #fff;">￥<font class="wrapRefreshShow">0</font><i style="padding-left: 0%;" class="iconfont refresh_money">&#xe602;</i></span>
        </div>
  </header>
	...
	<div class="open_containers g_Time_Section" style="    padding-top: 9%;">
        <!--彩种开奖倒计时-->
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls">
			...
			<div class="notCTCP"><span class="triangle"></span></div><div>
    ...
    <div  class="menuMain">
      <div  class="topInfo fix">
        ...
        <div  class="myInfo">
          ...
          <p class="wrapRefreshShow">¥ {$userinfo['balance']}</p></div>
      ...
      <div  class="navBar">
        ...
        <a >
          ...
          <span >我要提现</span></a>
        <a  href="{:U('Account/withdrawals')}" class="active">
          <i  class="iconfont  icon-jiaoyijilu" style="color:#4ad2c8;"></i>
          <span >交易记录</span></a>
        <a  href="{:U('Account/dealRecord')}" class="active">
          <i  class="iconfont icon-touzhujilu" style="color:#62a5f6;"></i>
          <span >投注记录</span></a>
        <a  href="{:U('Account/todayLoss')}" class="active">
        ...
        <a  href="{:GetVar('kefuthree')}" class="active">
          ...
          <span >在线客服</span></a>
        <a  href="javascript:if(confirm('是否退出？'))location='{:U('Public/LoginOut')}'" class="active">
