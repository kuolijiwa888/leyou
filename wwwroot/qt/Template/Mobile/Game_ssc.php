  ...
  <div class="by-lottery">
    <div class="lottery-top">
      <div class="lottery-top-0">
        <div class="gameType play_wanfa"><span style="font-weight:800">标准玩法</span><span style="float:right;" class=""><string>五星复式</string><i class="iconfont">&#xe618;</i></span></div>
        ...
        <div class="play_select_insert animated linearTop" style="position: fixed;left: 50%;top: 50%;z-index: 20001;width: 3.35rem;height: auto;-webkit-transform: translate(-50%,-50%);transform: translate(-50%,-50%);display: none;" id="j_play_select">
          <div class="play_select_top">
            ...
            <span ontouchend="window.location.href='/lotterys_hot/ssc/{:I('code')}/1'"><i class="iconfont">&#xe639;</i>[切换到双面]</span>
          </div>
          <ul class="play_select_tit" style="height: 69vh;max-height: 69vh;padding: 0;overflow: hidden;overflow-y: auto;">
            <li lottery_code="5x" id="5x" class="curr">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 五星</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box1" id="5xs" style="display: none;">
            </div>
            <li lottery_code="4x" id="4x">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 四星</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box2" id="4xs" style="display: none;">
            </div>
            <li lottery_code="q3" id="q3">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 前三</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box3" id="q3s" style="display: none;">
            </div>
            <li lottery_code="z3" id="z3">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 中三</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box4" id="z3s" style="display: none;">
            </div>
            <li lottery_code="h3" id="h3">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 后三</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box5" id="h3s" style="display: none;">
            </div>
            <li lottery_code="q2" id="q2">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 前二</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box6" id="q2s" style="display: none;">
            </div>
            <li lottery_code="h2" id="h2">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 后二</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box7" id="h2s" style="display: none;">
            </div>
            <li lottery_code="1x" id="1x">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 一星</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box8" id="1xs"style="display: none;">
            </div>
            <li lottery_code="dsds" id="dsds">
              <i class="iconfont qian"></i><div class="div11 wanfa"> 大小单双</div>
              <div class="div11" style="float: right;"><i class="iconfont hou"></i></div>
            </li>
            <div class="kuang2 bet_filter_box9" id="dsdss" style="display: none;">
            </div>
          </ul>
        </div>
