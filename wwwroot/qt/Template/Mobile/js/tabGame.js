 ...
 $('.noe').click(function(){
  ...
  $(document).on('click','#j_play_select .play_select_tit li',function () {
    ...
    switch(this_attr){
     ...
     case '5x':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box1'),ssc_5x_title,ssc_5x_arr);
     _thisPlayid = 'wxzhixfs';
     rates = yrates[_thisPlayid];
     $('.play_select_prompt').find('span[way-data="tabDoc"]')
     .html('每位至少选择一个号码，竞猜开奖号码的全部五位，号码和位置都对应即中奖，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
     ...
     case '4x':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box2'),ssc_4x_title,ssc_4x_arr);
     ...
     case 'q3':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box3'),ssc_q3_title,ssc_q3_arr);
     ...
     case 'z3':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box4'),ssc_q3_title,ssc_z3_arr);
     ...
     case 'h3':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box5'),ssc_q3_title,ssc_h3_arr);
     ...
     case 'q2':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box6'),ssc_q2_title,ssc_q2_arr);
     ...
     case 'h2':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box7'),ssc_q2_title,ssc_h2_arr);
     ...
     case '1x':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box8'),ssc_1x_title,ssc_1x_arr);
     _thisPlayid = 'dweid';
     rates = yrates[_thisPlayid];
     $('.play_select_prompt').find('span[way-data="tabDoc"]')
     .html('从万位、千位、百位、十位、个位任意位置上至少选择1个号码，选号与相同位置上的开奖号码一致，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
     ...
     case 'dsds':
     $('#bet_filter').remove();
     gameSwitch($('.bet_filter_box9'),ssc_dsds_title,ssc_dsds_arr);
     _thisPlayid = 'dxdsqe';
     rates = yrates[_thisPlayid];
     $('.play_select_prompt').find('span[way-data="tabDoc"]')
     .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
