...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<div class="lotterys"><div class="rq">第 '+openinfo.expect+' 期</div><div class="hm"><span class="qiu pk10_num_'+array[0]+'">'+array[0]+'</span><span class="qiu pk10_num_'+array[1]+'">'+array[1]+'</span><span class="qiu pk10_num_'+array[2]+'">'+array[2]+'</span><span class="qiu pk10_num_'+array[3]+'">'+array[3]+'</span><span class="qiu pk10_num_'+array[4]+'">'+array[4]+'</span><span class="qiu pk10_num_'+array[5]+'">'+array[5]+'</span><span class="qiu pk10_num_'+array[6]+'">'+array[6]+'</span><span class="qiu pk10_num_'+array[7]+'">'+array[7]+'</span><span class="qiu pk10_num_'+array[8]+'">'+array[8]+'</span><span class="qiu pk10_num_'+array[9]+'">'+array[9]+'</span></div></div>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<div class="lotterys"><div class="rq">第 ' + openexpect + ' 期</div><div class="hm';
                        html += '">';
                        for (var j = 0; j < openCodes.length; j++) {
                          if(j == openCodes.length - 1){
                            html += '<span class="qiu pk10_num_'+openCodes[j]+'">'+openCodes[j]+'</span>';
                          } else {
                            html += '<span class="qiu pk10_num_'+openCodes[j]+'">'+openCodes[j]+'</span>';
                          }
                        }
