  ...
  var lhc_tmlm_playid = ['tmlmda','tmlmxiao','tmlmdan','tmlmshuang','tmlmdadan','tmlmdashuang',
  ...
  var lhc_zm1lm_playid = ['zm1lmda','zm1lmxiao','zm1lmdan','zm1lmshuang','zm1lmdadan','zm1lmdashuang',
                      'zm1lmxiaodan','zm1lmxiaoshuang','zm1lmheda','zm1lmhexiao','zm1lmhedan','zm1lmheshuang',
                      'zm1lmweida','zm1lmweixiao','zm1lmjiaqin','zm1lmyeshou','zm1lmhongbo','zm1lmlvbo','zm1lmlanbo'];
                      
  var lhc_zm2lm_playid = ['zm2lmda','zm2lmxiao','zm2lmdan','zm2lmshuang','zm2lmdadan','zm2lmdashuang',
                      'zm2lmxiaodan','zm2lmxiaoshuang','zm2lmheda','zm2lmhexiao','zm2lmhedan','zm2lmheshuang',
                      'zm2lmweida','zm2lmweixiao','zm2lmjiaqin','zm2lmyeshou','zm2lmhongbo','zm2lmlvbo','zm2lmlanbo'];
                      
  var lhc_zm3lm_playid = ['zm3lmda','zm3lmxiao','zm3lmdan','zm3lmshuang','zm3lmdadan','zm3lmdashuang',
                      'zm3lmxiaodan','zm3lmxiaoshuang','zm3lmheda','zm3lmhexiao','zm3lmhedan','zm3lmheshuang',
                      'zm3lmweida','zm3lmweixiao','zm3lmjiaqin','zm3lmyeshou','zm3lmhongbo','zm3lmlvbo','zm3lmlanbo'];
                      
  var lhc_zm4lm_playid = ['zm4lmda','zm4lmxiao','zm4lmdan','zm4lmshuang','zm4lmdadan','zm4lmdashuang',
                      'zm4lmxiaodan','zm4lmxiaoshuang','zm4lmheda','zm4lmhexiao','zm4lmhedan','zm4lmheshuang',
                      'zm4lmweida','zm4lmweixiao','zm4lmjiaqin','zm4lmyeshou','zm4lmhongbo','zm4lmlvbo','zm4lmlanbo'];
                      
  var lhc_zm5lm_playid = ['zm5lmda','zm5lmxiao','zm5lmdan','zm5lmshuang','zm5lmdadan','zm5lmdashuang',
                      'zm5lmxiaodan','zm5lmxiaoshuang','zm5lmheda','zm5lmhexiao','zm5lmhedan','zm5lmheshuang',
                      'zm5lmweida','zm5lmweixiao','zm5lmjiaqin','zm5lmyeshou','zm5lmhongbo','zm5lmlvbo','zm5lmlanbo'];
                      
  var lhc_zm6lm_playid = ['zm6lmda','zm6lmxiao','zm6lmdan','zm6lmshuang','zm6lmdadan','zm6lmdashuang',
                      'zm6lmxiaodan','zm6lmxiaoshuang','zm6lmheda','zm6lmhexiao','zm6lmhedan','zm6lmheshuang',
                      'zm6lmweida','zm6lmweixiao','zm6lmjiaqin','zm6lmyeshou','zm6lmhongbo','zm6lmlvbo','zm6lmlanbo'];
                      
  var lhc_tmbb_playid = ['hongda','hongxiao','hongdan','hongshuang','honghedan','hongheshuang',
                      'lvda','lvxiao','lvdan','lvshuang','lvhedan','lvheshuang',
                      'landa','lanxiao','landan','lanshuang','lanhedan','lanheshuang'];
                      
  var lhc_sxtx_playid = ['sxtxshu','sxtxniu','sxtxhu','sxtxtu','sxtxlong','sxtxshe',
                      'sxtxma','sxtxyang','sxtxhou','sxtxji','sxtxgou','sxtxzhu'];
                      
  var lhc_sx1x_playid = ['sx1xshu','sx1xniu','sx1xhu','sx1xtu','sx1xlong','sx1xshe',
                      'sx1xma','sx1xyang','sx1xhou','sx1xji','sx1xgou','sx1xzhu'];
                      
  var lhc_wstw_playid = ['lingtou','yitou','ertou','santou','sitou','lingwei',
                      'yiwei','erwei','sanwei','siwei','wuwei','luwei','qiwei','bawei','jiuwei'];
  //特码半波
  var lhc_tmbb_arr = [
    {
      'tmbb': '特码半波'
...
//时时彩开始
  ...
  //北京pk10开始
  //定位胆
  var bjpks_pk10lhd_arr = [
    {
      'bjpk10dwd': '复式'
    }
  ];
  var bjpks_pk10lhd_title = ['标准'];
  var bjpks_pk10lhd = ['冠军/第十','亚军/第九','季军/第八','第四/第七','第五/第六'];
  //定位胆
  var bjpks_dwd_arr = [
    {
      'bjpk10dwd': '定位胆'
  ...
  var lhc_yss = {
    'hong':['01','02','07','08','12','13','18','19','23','24','29','30','35','34','40','45','16'],
    'lan':['03','04','09','10','14','15','20','25','26','31','37','36','41','42','47','48'],
    'lv':['05','06','11','16','17','22','21','28','27','32','33','38','39','43','44','49']
  };
  //六合彩对应数据
  var lhc_numData = {
    'lhc_01': {
  ...
  for (var i in lhc_sxs) {
    var shengxiaos = lhc_sxs[i];
    for (var j in shengxiaos) {
      lhc_numData['lhc_'+shengxiaos[j]].sx = i;
    }
  }
  for (var i in lhc_yss) {
    var yanse = lhc_yss[i];
    for (var j in yanse) {
      lhc_numData['lhc_'+yanse[j]].bo = i;
    }
  }
  var xy28_tmbb_content = ['红波|hong','绿波|lv',
                          '蓝波|lan'];						  
						  
		  var xy28_tmlm_content = ['大|big','小|small','单|odd','双|even','大单|big_odd','大双|big_even',
                      '小单|small_odd','小双|small_even','极大|ji_big','极小|ji_small','豹子|baozi'];		
  //六合彩对应数据
  var xy28_sxs = {
    '鼠':['11','23','35','47'],
    '牛':['10','22','34','46'],
  ...
  for (var i in xy28_yss) {
    var yanse = xy28_yss[i];
    for (var j in yanse) {
      xy28_numData['xy28_'+yanse[j]].bo = i;
    }
  }
