...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<div class="lotterys"><div class="rq">第 '+openinfo.expect+' 期</div><div class="hm"><span class="qiu">'+array[0]+'</span><span class="qiu">'+array[1]+'</span><span class="qiu">'+array[2]+'</span><span class="qiu">'+array[3]+'</span><span class="qiu">'+array[4]+'</span></div></div>';
