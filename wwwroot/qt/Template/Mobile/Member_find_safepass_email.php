...
<body>
	...
	<div class="gaimi">
		<form action="/userCenter/find_email" method="post" onsubmit="return checkform(this)">
			<div class="gaimi-top">
				<ul>
					<li>
						<div class="gaimi-top-name">邮箱账号:</div>
						<div class="gaimi-top-mima"><input type="text" placeholder="请输入当前邮箱账号" name="email"></div>
					</li>
					<li>
