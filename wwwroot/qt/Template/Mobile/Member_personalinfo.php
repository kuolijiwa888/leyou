			...
			<ul class="my_set_list personalInfo_top margin_0" >
				<li class="am-cf " >
					...
					<em class="personalInfo_text am-fr padding_lr_5">
						...
						<eq name="userinfo['userbankname']"  ><a href="/userbankname">去绑定</a><else /><a href="/userbankname">{$userinfo['userbankname']|substr_replace='*',3,3}</a></eq>
					</em>
				</li>
				<li class="am-cf " >
					<span>手机</span>
...
<eq name="userinfo['tel']"><a href="/safephone">去绑定</a><else /><a href="/safephone">{$userinfo['tel']|substr_replace='****',3,4}</a></eq>
					</em>
				</li>
				<li class="am-cf">
					<span>邮箱</span>
					<i class="iconfont icon-arrowright"></i>
					<em class="personalInfo_text am-fr padding_lr_5">
						<eq name="userinfo['email']"><a href="/bindmail">去绑定</a><else /><a href="/bindmail">{$userinfo['email']|substr_replace='****',3,4}</a></eq>
					</em>
				</li>
				<li class="am-cf">
					<span>QQ</span>
