          ...
          <nav class="bar bar-tab" style="background-color: #000;">
              <a class="tab-item external active" href="/home" style="color: #fff;">
              ...
              <a class="tab-item external" href="/userCenter/betRecord" style="color: #fff;">
              ...
              <a class="tab-item external" href="/memberCenter/securityCenter" style="color: #fff;">
