...
<body>
	...
	<div class="gaimi">
		<form action="/bindmail" method="post" onsubmit="return checkform(this)">
			<div class="gaimi-top">
				<ul>
					<li>
						<div class="gaimi-top-name">密保手机:</div>
						<div class="gaimi-top-mima"><input type="text" name="emial" value="{$userinfo.email}"  placeholder="请输入你需要绑定的邮箱"></div>
					</li>
				</ul>
