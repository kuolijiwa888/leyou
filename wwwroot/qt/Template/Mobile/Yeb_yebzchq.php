...
<body>
	...
	<div class="yeb-zhuan">
		<div class="yeb-zhuan-title">
			...
			<div class="zhuan-title-2" onclick="window.location.href='/yebCenter/yebzclx'">
				<span>利息转出</span>
			</div>
		</div>
		...
		<div class="yeb-zhuan-button">
			<button class="" id="zhuanchu">立即转出</button>
		</div>
	</div>
	...
	<script>
		$(function(){
			function checkInput(){
				...
				if(userFlag!==''){
					$('#zhuanchu').addClass('active');
					$('#zhuanchu').attr("disabled",false);
				}else{
					$('#zhuanchu').removeClass('active');
					$('#zhuanchu').attr("disabled",true);
				}
			};
