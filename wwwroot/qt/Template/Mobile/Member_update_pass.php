...
<body>
	...
	<div class="gaimi">
		<form action="/userCenter/verifyPwd" method="post" onsubmit="return checkform(this)">
			<div class="gaimi-top">
				<ul>
					<li>
						<div class="gaimi-top-name">原登录密码:</div>
						<div class="gaimi-top-mima"><input type="password" placeholder="请输入当前登录密码" name="pa1"></div>
					</li>
					<li>
						<div class="gaimi-top-name">新登录密码:</div>
						<div class="gaimi-top-mima"><input type="password" placeholder="请输入新登录密码" name="password"></div>
					</li>
					<li>
						<div class="gaimi-top-name">确认登录密码:</div>
						<div class="gaimi-top-mima"><input type="password" placeholder="再次输入新登录密码确认" name="password2"></div>
					</li>
				</ul>
