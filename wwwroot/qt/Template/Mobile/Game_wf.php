			...
			<div class="ui-row-flex">
				<div class="ui-col ui-col-4 line-box">
					<ul class="ball_list_ul">
						...
						<li class="ball_item"><a playid="k3hzbigodd" ball-type="k3hzzx" ball-number="大单" href="javascript:void(0)" class="ball_number" peilv="{$peilv.k3hzbigodd}"><b>大单</b>
								<p class="peilv">
									赔率{$peilv.k3hzbigodd}
								</p>
							</a></li>
						<li class="ball_item"><a playid="k3hzsmallodd" ball-type="k3hzzx" ball-number="小单" href="javascript:void(0)" class="ball_number" peilv="{$peilv.k3hzsmallodd}"><b>小单</b>
								<p class="peilv">
									赔率{$peilv.k3hzsmallodd}
								</p>
							</a></li>
						<li class="ball_item"><a playid="k3hzbigeven" ball-type="k3hzzx" ball-number="大双" href="javascript:void(0)" class="ball_number" peilv="{$peilv.k3hzbigeven}"><b>大双</b>
								<p class="peilv">
									赔率{$peilv.k3hzbigeven}
								</p>
							</a></li>
						<li class="ball_item"><a playid="k3hzsmalleven" ball-type="k3hzzx" ball-number="小双" href="javascript:void(0)" class="ball_number" peilv="{$peilv.k3hzsmalleven}"><b>小双</b>
								<p class="peilv">
									赔率{$peilv.k3hzsmalleven}
								</p>
							</a></li>
...
<!-- <p class="remark" style="color:#999">
			从1～6中任选2个或多个号码，所选号码与开奖号码任意2个号码相同，即为中奖。奖金{$peilv.k3hhm}倍
		</p> -->
<script type="text/html" id="k3hhm_wf">
	<!--红黑码-->
	<div id="k3hhm" class="ball_section section_cqssc">
				...
				<div class="ui-col ui-col-4 line-box gn_main_list">
					<ul class="ball_list_ul">
						<li style="width:50%" class=" ball_item">
							<a ball-number="红码" ball-type="k3hhm" playid="hhmhong" href="javascript:void(0)" class="ball_number">
								<b>红码</b>
							</a>
						</li>
						<li style="width:50%" class=" ball_item">
							<a ball-number="黑码" ball-type="k3hhm" playid="hhmhei" href="javascript:void(0)" class="ball_number">
								<b>黑码</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="红码大" ball-type="k3hhm" playid="hhmhongd" href="javascript:void(0)" class="ball_number">
								<b>红码大</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="红码小" ball-type="k3hhm" playid="hhmhongx" href="javascript:void(0)" class="ball_number">
								<b>红码小</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="红码单" ball-type="k3hhm" playid="hhmhongdd" href="javascript:void(0)" class="ball_number">
								<b>红码单</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="红码双" ball-type="k3hhm" playid="hhmhongss" href="javascript:void(0)" class="ball_number">
								<b>红码双</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="黑码大" ball-type="k3hhm" playid="hhmheid" href="javascript:void(0)" class="ball_number">
								<b>黑码大</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="黑码小" ball-type="k3hhm" playid="hhmheix" href="javascript:void(0)" class="ball_number">
								<b>黑码小</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="黑码单" ball-type="k3hhm" playid="hhmheidd" href="javascript:void(0)" class="ball_number">
								<b>黑码单</b>
							</a>
						</li>
						<li style="width:25%" class=" ball_item">
							<a ball-number="黑码双" ball-type="k3hhm" playid="hhmheixx" href="javascript:void(0)" class="ball_number">
								<b>黑码双</b>
							</a>
						</li>
						...
						<li style="width:33.3%" class=" ball_item">
							<a ball-number="四码红" ball-type="k3ebthbz" playid="hhmhong4hong" href="javascript:void(0)" class="ball_number">
								<b>四码红</b>
							</a>
						</li>
						<li style="width:33.3%" class=" ball_item">
							<a ball-number="四码黑" ball-type="k3ebthbz" playid="hhmhong4hei" href="javascript:void(0)" class="ball_number">
								<b>四码黑</b>
							</a>
						</li>
						<li style="width:33.3%" class=" ball_item">
							<a ball-number="五码黑" ball-type="k3ebthbz" playid="hhmhong5hei" href="javascript:void(0)" class="ball_number">
								<b>五码黑</b>
							</a>
						</li>
						<li style="width:100%" class=" ball_item">
						...
						<li style="width:16.6%" class=" ball_item">
							<a ball-number="1" ball-type="k3ebthbz" playid="hhmhei5hei" href="javascript:void(0)" class="selectNumberSum">
								<b>1</b>
							</a>
						</li>
						<li style="width:16.6%" class=" ball_item">
							<a ball-number="2" ball-type="k3ebthbz" playid="hhmhei5hei" href="javascript:void(0)" class="selectNumberSum">
								<b>2</b>
							</a>
						</li>
						<li style="width:16.6%" class=" ball_item">
							<a ball-number="3" ball-type="k3ebthbz" playid="hhmhei5hei" href="javascript:void(0)" class="selectNumberSum">
								<b>3</b>
							</a>
						</li>
						<li style="width:16.6%" class=" ball_item">
							<a ball-number="4" ball-type="k3ebthbz" playid="hhmhei5hei" href="javascript:void(0)" class="selectNumberSum">
								<b>4</b>
							</a>
						</li>
						<li style="width:16.6%" class=" ball_item">
							<a ball-number="5" ball-type="k3ebthbz" playid="hhmhei5hei" href="javascript:void(0)" class="selectNumberSum">
								<b>5</b>
							</a>
						</li>
						<li style="width:16.6%" class=" ball_item">
							<a ball-number="6" ball-type="k3ebthbz" playid="hhmhei5hei" href="javascript:void(0)" class="selectNumberSum">
								<b>6</b>
							</a>
						</li>
					</ul>
